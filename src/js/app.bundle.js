...
`].filter(ir).join(`
`)),a=Dl(a),a=nu(a,e),a=iu(a,e),o=Dl(o),o=nu(o,e),o=iu(o,e),a=su(a),o=su(o),e.isRawShaderMaterial!==!0&&(w=`#version 300 es
...
`)+`
`+d);let b=w+m+a,M=w+d+o,P=Qh(s,s.VERTEX_SHADER,b),A=Qh(s,s.FRAGMENT_SHADER,M);s.attachShader(x,P),s.attachShader(x,A),e.index0AttributeName!==void 0?s.bindAttribLocation(x,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function R(T){if(i.debug.checkShaderErrors){let N=s.getProgramInfoLog(x).trim(),C=s.getShaderInfoLog(P).trim(),H=s.getShaderInfoLog(A).trim(),G=!0,X=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(G=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,P,A);else{let Q=eu(s,P,"vertex"),q=eu(s,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
Program Info Log: `+N+`
`+Q+`
`+q)}else N!==""?console.warn("THREE.WebGLProgram: Program Info Log:",N):(C===""||H==="")&&(X=!1);X&&(T.diagnostics={runnable:G,programLog:N,vertexShader:{log:C,prefix:m},fragmentShader:{log:H,prefix:d}})}s.deleteShader(P),s.deleteShader(A),L=new us(s,x),y=Ig(s,x)}let L;this.getUniforms=function(){return L===void 0&&R(this),L};let y;this.getAttributes=function(){return y===void 0&&R(this),y};let g=e.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return g===!1&&(g=s.getProgramParameter(x,Mg)),g},this.destroy=function(){n.releaseStatesOfProgram(this),s.deleteProgram(x),this.program=void 0},this.type=e.shaderType,this.name=e.shaderName,this.id=bg++,this.cacheKey=t,this.usedTimes=1,this.program=x,this.vertexShader=P,this.fragmentShader=A,this}var Gg=0,Ul=class{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(t){let e=t.vertexShader,n=t.fragmentShader,s=this._getShaderStage(e),r=this._getShaderStage(n),a=this._getShaderCacheForMaterial(t);return a.has(s)===!1&&(a.add(s),s.usedTimes++),a.has(r)===!1&&(a.add(r),r.usedTimes++),this}remove(t){let e=this.materialCache.get(t);for(let n of e)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(t),this}getVertexShaderID(t){return this._getShaderStage(t.vertexShader).id}getFragmentShaderID(t){return this._getShaderStage(t.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(t){let e=this.materialCache,n=e.get(t);return n===void 0&&(n=new Set,e.set(t,n)),n}_getShaderStage(t){let e=this.shaderCache,n=e.get(t);return n===void 0&&(n=new Nl(t),e.set(t,n)),n}},Nl=class{constructor(t){this.id=Gg++,this.code=t,this.usedTimes=0}};function Wg(i,t,e,n,s,r,a){let o=new ji,l=new Ul,c=new Set,h=[],u=s.logarithmicDepthBuffer,f=s.vertexTextures,p=s.precision,_={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function x(y){return c.add(y),y===0?"uv":`uv${y}`}function m(y,g,T,N,C){let H=N.fog,G=C.geometry,X=y.isMeshStandardMaterial?N.environment:null,Q=(y.isMeshStandardMaterial?e:t).get(y.envMap||X),q=Q&&Q.mapping===Ks?Q.image.height:null,rt=_[y.type];y.precision!==null&&(p=s.getMaxPrecision(y.precision),p!==y.precision&&console.warn("THREE.WebGLProgram.getParameters:",y.precision,"not supported, using",p,"instead."));let ut=G.morphAttributes.position||G.morphAttributes.normal||G.morphAttributes.color,vt=ut!==void 0?ut.length:0,Ot=0;G.morphAttributes.position!==void 0&&(Ot=1),G.morphAttributes.normal!==void 0&&(Ot=2),G.morphAttributes.color!==void 0&&(Ot=3);let Qt,$,et,_t;if(rt){let Kt=Tn[rt];Qt=Kt.vertexShader,$=Kt.fragmentShader}else Qt=y.vertexShader,$=y.fragmentShader,l.update(y),et=l.getVertexShaderID(y),_t=l.getFragmentShaderID(y);let at=i.getRenderTarget(),Tt=i.state.buffers.depth.getReversed(),Pt=C.isInstancedMesh===!0,Bt=C.isBatchedMesh===!0,ae=!!y.map,Vt=!!y.matcap,fe=!!Q,I=!!y.aoMap,Je=!!y.lightMap,zt=!!y.bumpMap,kt=!!y.normalMap,xt=!!y.displacementMap,ee=!!y.emissiveMap,St=!!y.metalnessMap,E=!!y.roughnessMap,v=y.anisotropy>0,B=y.clearcoat>0,Z=y.dispersion>0,J=y.iridescence>0,Y=y.sheen>0,yt=y.transmission>0,ot=v&&!!y.anisotropyMap,dt=B&&!!y.clearcoatMap,Gt=B&&!!y.clearcoatNormalMap,tt=B&&!!y.clearcoatRoughnessMap,ft=J&&!!y.iridescenceMap,Et=J&&!!y.iridescenceThicknessMap,At=Y&&!!y.sheenColorMap,pt=Y&&!!y.sheenRoughnessMap,Ht=!!y.specularMap,Dt=!!y.specularColorMap,te=!!y.specularIntensityMap,D=yt&&!!y.transmissionMap,it=yt&&!!y.thicknessMap,W=!!y.gradientMap,K=!!y.alphaMap,ct=y.alphaTest>0,lt=!!y.alphaHash,Lt=!!y.extensions,he=Bn;y.toneMapped&&(at===null||at.isXRRenderTarget===!0)&&(he=i.toneMapping);let Ce={shaderID:rt,shaderType:y.type,shaderName:y.name,vertexShader:Qt,fragmentShader:$,defines:y.defines,customVertexShaderID:et,customFragmentShaderID:_t,isRawShaderMaterial:y.isRawShaderMaterial===!0,glslVersion:y.glslVersion,precision:p,batching:Bt,batchingColor:Bt&&C._colorsTexture!==null,instancing:Pt,instancingColor:Pt&&C.instanceColor!==null,instancingMorph:Pt&&C.morphTexture!==null,supportsVertexTextures:f,outputColorSpace:at===null?i.outputColorSpace:at.isXRRenderTarget===!0?at.texture.colorSpace:Mi,alphaToCoverage:!!y.alphaToCoverage,map:ae,matcap:Vt,envMap:fe,envMapMode:fe&&Q.mapping,envMapCubeUVHeight:q,aoMap:I,lightMap:Je,bumpMap:zt,normalMap:kt,displacementMap:f&&xt,emissiveMap:ee,normalMapObjectSpace:kt&&y.normalMapType===wh,normalMapTangentSpace:kt&&y.normalMapType===pl,metalnessMap:St,roughnessMap:E,anisotropy:v,anisotropyMap:ot,clearcoat:B,clearcoatMap:dt,clearcoatNormalMap:Gt,clearcoatRoughnessMap:tt,dispersion:Z,iridescence:J,iridescenceMap:ft,iridescenceThicknessMap:Et,sheen:Y,sheenColorMap:At,sheenRoughnessMap:pt,specularMap:Ht,specularColorMap:Dt,specularIntensityMap:te,transmission:yt,transmissionMap:D,thicknessMap:it,gradientMap:W,opaque:y.transparent===!1&&y.blending===vi&&y.alphaToCoverage===!1,alphaMap:K,alphaTest:ct,alphaHash:lt,combine:y.combine,mapUv:ae&&x(y.map.channel),aoMapUv:I&&x(y.aoMap.channel),lightMapUv:Je&&x(y.lightMap.channel),bumpMapUv:zt&&x(y.bumpMap.channel),normalMapUv:kt&&x(y.normalMap.channel),displacementMapUv:xt&&x(y.displacementMap.channel),emissiveMapUv:ee&&x(y.emissiveMap.channel),metalnessMapUv:St&&x(y.metalnessMap.channel),roughnessMapUv:E&&x(y.roughnessMap.channel),anisotropyMapUv:ot&&x(y.anisotropyMap.channel),clearcoatMapUv:dt&&x(y.clearcoatMap.channel),clearcoatNormalMapUv:Gt&&x(y.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:tt&&x(y.clearcoatRoughnessMap.channel),iridescenceMapUv:ft&&x(y.iridescenceMap.channel),iridescenceThicknessMapUv:Et&&x(y.iridescenceThicknessMap.channel),sheenColorMapUv:At&&x(y.sheenColorMap.channel),sheenRoughnessMapUv:pt&&x(y.sheenRoughnessMap.channel),specularMapUv:Ht&&x(y.specularMap.channel),specularColorMapUv:Dt&&x(y.specularColorMap.channel),specularIntensityMapUv:te&&x(y.specularIntensityMap.channel),transmissionMapUv:D&&x(y.transmissionMap.channel),thicknessMapUv:it&&x(y.thicknessMap.channel),alphaMapUv:K&&x(y.alphaMap.channel),vertexTangents:!!G.attributes.tangent&&(kt||v),vertexColors:y.vertexColors,vertexAlphas:y.vertexColors===!0&&!!G.attributes.color&&G.attributes.color.itemSize===4,pointsUvs:C.isPoints===!0&&!!G.attributes.uv&&(ae||K),fog:!!H,useFog:y.fog===!0,fogExp2:!!H&&H.isFogExp2,flatShading:y.flatShading===!0,sizeAttenuation:y.sizeAttenuation===!0,logarithmicDepthBuffer:u,reverseDepthBuffer:Tt,skinning:C.isSkinnedMesh===!0,morphTargets:G.morphAttributes.position!==void 0,morphNormals:G.morphAttributes.normal!==void 0,morphColors:G.morphAttributes.color!==void 0,morphTargetsCount:vt,morphTextureStride:Ot,numDirLights:g.directional.length,numPointLights:g.point.length,numSpotLights:g.spot.length,numSpotLightMaps:g.spotLightMap.length,numRectAreaLights:g.rectArea.length,numHemiLights:g.hemi.length,numDirLightShadows:g.directionalShadowMap.length,numPointLightShadows:g.pointShadowMap.length,numSpotLightShadows:g.spotShadowMap.length,numSpotLightShadowsWithMaps:g.numSpotLightShadowsWithMaps,numLightProbes:g.numLightProbes,numClippingPlanes:a.numPlanes,numClipIntersection:a.numIntersection,dithering:y.dithering,shadowMapEnabled:i.shadowMap.enabled&&T.length>0,shadowMapType:i.shadowMap.type,toneMapping:he,decodeVideoTexture:ae&&y.map.isVideoTexture===!0&&Xt.getTransfer(y.map.colorSpace)===Jt,decodeVideoTextureEmissive:ee&&y.emissiveMap.isVideoTexture===!0&&Xt.getTransfer(y.emissiveMap.colorSpace)===Jt,premultipliedAlpha:y.premultipliedAlpha,doubleSided:y.side===an,flipSided:y.side===Te,useDepthPacking:y.depthPacking>=0,depthPacking:y.depthPacking||0,index0AttributeName:y.index0AttributeName,extensionClipCullDistance:Lt&&y.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(Lt&&y.extensions.multiDraw===!0||Bt)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:y.customProgramCacheKey()};return Ce.vertexUv1s=c.has(1),Ce.vertexUv2s=c.has(2),Ce.vertexUv3s=c.has(3),c.clear(),Ce}function d(y){let g=[];if(y.shaderID?g.push(y.shaderID):(g.push(y.customVertexShaderID),g.push(y.customFragmentShaderID)),y.defines!==void 0)for(let T in y.defines)g.push(T),g.push(y.defines[T]);return y.isRawShaderMaterial===!1&&(w(g,y),b(g,y),g.push(i.outputColorSpace)),g.push(y.customProgramCacheKey),g.join()}function w(y,g){y.push(g.precision),y.push(g.outputColorSpace),y.push(g.envMapMode),y.push(g.envMapCubeUVHeight),y.push(g.mapUv),y.push(g.alphaMapUv),y.push(g.lightMapUv),y.push(g.aoMapUv),y.push(g.bumpMapUv),y.push(g.normalMapUv),y.push(g.displacementMapUv),y.push(g.emissiveMapUv),y.push(g.metalnessMapUv),y.push(g.roughnessMapUv),y.push(g.anisotropyMapUv),y.push(g.clearcoatMapUv),y.push(g.clearcoatNormalMapUv),y.push(g.clearcoatRoughnessMapUv),y.push(g.iridescenceMapUv),y.push(g.iridescenceThicknessMapUv),y.push(g.sheenColorMapUv),y.push(g.sheenRoughnessMapUv),y.push(g.specularMapUv),y.push(g.specularColorMapUv),y.push(g.specularIntensityMapUv),y.push(g.transmissionMapUv),y.push(g.thicknessMapUv),y.push(g.combine),y.push(g.fogExp2),y.push(g.sizeAttenuation),y.push(g.morphTargetsCount),y.push(g.morphAttributeCount),y.push(g.numDirLights),y.push(g.numPointLights),y.push(g.numSpotLights),y.push(g.numSpotLightMaps),y.push(g.numHemiLights),y.push(g.numRectAreaLights),y.push(g.numDirLightShadows),y.push(g.numPointLightShadows),y.push(g.numSpotLightShadows),y.push(g.numSpotLightShadowsWithMaps),y.push(g.numLightProbes),y.push(g.shadowMapType),y.push(g.toneMapping),y.push(g.numClippingPlanes),y.push(g.numClipIntersection),y.push(g.depthPacking)}function b(y,g){o.disableAll(),g.supportsVertexTextures&&o.enable(0),g.instancing&&o.enable(1),g.instancingColor&&o.enable(2),g.instancingMorph&&o.enable(3),g.matcap&&o.enable(4),g.envMap&&o.enable(5),g.normalMapObjectSpace&&o.enable(6),g.normalMapTangentSpace&&o.enable(7),g.clearcoat&&o.enable(8),g.iridescence&&o.enable(9),g.alphaTest&&o.enable(10),g.vertexColors&&o.enable(11),g.vertexAlphas&&o.enable(12),g.vertexUv1s&&o.enable(13),g.vertexUv2s&&o.enable(14),g.vertexUv3s&&o.enable(15),g.vertexTangents&&o.enable(16),g.anisotropy&&o.enable(17),g.alphaHash&&o.enable(18),g.batching&&o.enable(19),g.dispersion&&o.enable(20),g.batchingColor&&o.enable(21),y.push(o.mask),o.disableAll(),g.fog&&o.enable(0),g.useFog&&o.enable(1),g.flatShading&&o.enable(2),g.logarithmicDepthBuffer&&o.enable(3),g.reverseDepthBuffer&&o.enable(4),g.skinning&&o.enable(5),g.morphTargets&&o.enable(6),g.morphNormals&&o.enable(7),g.morphColors&&o.enable(8),g.premultipliedAlpha&&o.enable(9),g.shadowMapEnabled&&o.enable(10),g.doubleSided&&o.enable(11),g.flipSided&&o.enable(12),g.useDepthPacking&&o.enable(13),g.dithering&&o.enable(14),g.transmission&&o.enable(15),g.sheen&&o.enable(16),g.opaque&&o.enable(17),g.pointsUvs&&o.enable(18),g.decodeVideoTexture&&o.enable(19),g.decodeVideoTextureEmissive&&o.enable(20),g.alphaToCoverage&&o.enable(21),y.push(o.mask)}function M(y){let g=_[y.type],T;if(g){let N=Tn[g];T=Bh.clone(N.uniforms)}else T=y.uniforms;return T}function P(y,g){let T;for(let N=0,C=h.length;N<C;N++){let H=h[N];if(H.cacheKey===g){T=H,++T.usedTimes;break}}return T===void 0&&(T=new Vg(i,g,y,r),h.push(T)),T}function A(y){if(--y.usedTimes===0){let g=h.indexOf(y);h[g]=h[h.length-1],h.pop(),y.destroy()}}function R(y){l.remove(y)}function L(){l.dispose()}return{getParameters:m,getProgramCacheKey:d,getUniforms:M,acquireProgram:P,releaseProgram:A,releaseShaderCache:R,programs:h,dispose:L}}function Xg(){let i=new WeakMap;function t(a){return i.has(a)}function e(a){let o=i.get(a);return o===void 0&&(o={},i.set(a,o)),o}function n(a){i.delete(a)}function s(a,o,l){i.get(a)[o]=l}function r(){i=new WeakMap}return{has:t,get:e,remove:n,update:s,dispose:r}}function qg(i,t){return i.groupOrder!==t.groupOrder?i.groupOrder-t.groupOrder:i.renderOrder!==t.renderOrder?i.renderOrder-t.renderOrder:i.material.id!==t.material.id?i.material.id-t.material.id:i.z!==t.z?i.z-t.z:i.id-t.id}function au(i,t){return i.groupOrder!==t.groupOrder?i.groupOrder-t.groupOrder:i.renderOrder!==t.renderOrder?i.renderOrder-t.renderOrder:i.z!==t.z?t.z-i.z:i.id-t.id}function ou(){let i=[],t=0,e=[],n=[],s=[];function r(){t=0,e.length=0,n.length=0,s.length=0}function a(u,f,p,_,x,m){let d=i[t];return d===void 0?(d={id:u.id,object:u,geometry:f,material:p,groupOrder:_,renderOrder:u.renderOrder,z:x,group:m},i[t]=d):(d.id=u.id,d.object=u,d.geometry=f,d.material=p,d.groupOrder=_,d.renderOrder=u.renderOrder,d.z=x,d.group=m),t++,d}function o(u,f,p,_,x,m){let d=a(u,f,p,_,x,m);p.transmission>0?n.push(d):p.transparent===!0?s.push(d):e.push(d)}function l(u,f,p,_,x,m){let d=a(u,f,p,_,x,m);p.transmission>0?n.unshift(d):p.transparent===!0?s.unshift(d):e.unshift(d)}function c(u,f){e.length>1&&e.sort(u||qg),n.length>1&&n.sort(f||au),s.length>1&&s.sort(f||au)}function h(){for(let u=t,f=i.length;u<f;u++){let p=i[u];if(p.id===null)break;p.id=null,p.object=null,p.geometry=null,p.material=null,p.group=null}}return{opaque:e,transmissive:n,transparent:s,init:r,push:o,unshift:l,finish:h,sort:c}}function Yg(){let i=new WeakMap;function t(n,s){let r=i.get(n),a;return r===void 0?(a=new ou,i.set(n,[a])):s>=r.length?(a=new ou,r.push(a)):a=r[s],a}function e(){i=new WeakMap}return{get:t,dispose:e}}function $g(){let i={};return{get:function(t){if(i[t.id]!==void 0)return i[t.id];let e;switch(t.type){case"DirectionalLight":e={direction:new U,color:new Ft};break;case"SpotLight":e={position:new U,direction:new U,color:new Ft,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":e={position:new U,color:new Ft,distance:0,decay:0};break;case"HemisphereLight":e={direction:new U,skyColor:new Ft,groundColor:new Ft};break;case"RectAreaLight":e={color:new Ft,position:new U,halfWidth:new U,halfHeight:new U};break}return i[t.id]=e,e}}}function Zg(){let i={};return{get:function(t){if(i[t.id]!==void 0)return i[t.id];let e;switch(t.type){case"DirectionalLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new wt};break;case"SpotLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new wt};break;case"PointLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new wt,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[t.id]=e,e}}}var Kg=0;function Jg(i,t){return(t.castShadow?2:0)-(i.castShadow?2:0)+(t.map?1:0)-(i.map?1:0)}function jg(i){let t=new $g,e=Zg(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new U);let s=new U,r=new ie,a=new ie;function o(c){let h=0,u=0,f=0;for(let y=0;y<9;y++)n.probe[y].set(0,0,0);let p=0,_=0,x=0,m=0,d=0,w=0,b=0,M=0,P=0,A=0,R=0;c.sort(Jg);for(let y=0,g=c.length;y<g;y++){let T=c[y],N=T.color,C=T.intensity,H=T.distance,G=T.shadow&&T.shadow.map?T.shadow.map.texture:null;if(T.isAmbientLight)h+=N.r*C,u+=N.g*C,f+=N.b*C;else if(T.isLightProbe){for(let X=0;X<9;X++)n.probe[X].addScaledVector(T.sh.coefficients[X],C);R++}else if(T.isDirectionalLight){let X=t.get(T);if(X.color.copy(T.color).multiplyScalar(T.intensity),T.castShadow){let Q=T.shadow,q=e.get(T);q.shadowIntensity=Q.intensity,q.shadowBias=Q.bias,q.shadowNormalBias=Q.normalBias,q.shadowRadius=Q.radius,q.shadowMapSize=Q.mapSize,n.directionalShadow[p]=q,n.directionalShadowMap[p]=G,n.directionalShadowMatrix[p]=T.shadow.matrix,w++}n.directional[p]=X,p++}else if(T.isSpotLight){let X=t.get(T);X.position.setFromMatrixPosition(T.matrixWorld),X.color.copy(N).multiplyScalar(C),X.distance=H,X.coneCos=Math.cos(T.angle),X.penumbraCos=Math.cos(T.angle*(1-T.penumbra)),X.decay=T.decay,n.spot[x]=X;let Q=T.shadow;if(T.map&&(n.spotLightMap[P]=T.map,P++,Q.updateMatrices(T),T.castShadow&&A++),n.spotLightMatrix[x]=Q.matrix,T.castShadow){let q=e.get(T);q.shadowIntensity=Q.intensity,q.shadowBias=Q.bias,q.shadowNormalBias=Q.normalBias,q.shadowRadius=Q.radius,q.shadowMapSize=Q.mapSize,n.spotShadow[x]=q,n.spotShadowMap[x]=G,M++}x++}else if(T.isRectAreaLight){let X=t.get(T);X.color.copy(N).multiplyScalar(C),X.halfWidth.set(T.width*.5,0,0),X.halfHeight.set(0,T.height*.5,0),n.rectArea[m]=X,m++}else if(T.isPointLight){let X=t.get(T);if(X.color.copy(T.color).multiplyScalar(T.intensity),X.distance=T.distance,X.decay=T.decay,T.castShadow){let Q=T.shadow,q=e.get(T);q.shadowIntensity=Q.intensity,q.shadowBias=Q.bias,q.shadowNormalBias=Q.normalBias,q.shadowRadius=Q.radius,q.shadowMapSize=Q.mapSize,q.shadowCameraNear=Q.camera.near,q.shadowCameraFar=Q.camera.far,n.pointShadow[_]=q,n.pointShadowMap[_]=G,n.pointShadowMatrix[_]=T.shadow.matrix,b++}n.point[_]=X,_++}else if(T.isHemisphereLight){let X=t.get(T);X.skyColor.copy(T.color).multiplyScalar(C),X.groundColor.copy(T.groundColor).multiplyScalar(C),n.hemi[d]=X,d++}}m>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=nt.LTC_FLOAT_1,n.rectAreaLTC2=nt.LTC_FLOAT_2):(n.rectAreaLTC1=nt.LTC_HALF_1,n.rectAreaLTC2=nt.LTC_HALF_2)),n.ambient[0]=h,n.ambient[1]=u,n.ambient[2]=f;let L=n.hash;(L.directionalLength!==p||L.pointLength!==_||L.spotLength!==x||L.rectAreaLength!==m||L.hemiLength!==d||L.numDirectionalShadows!==w||L.numPointShadows!==b||L.numSpotShadows!==M||L.numSpotMaps!==P||L.numLightProbes!==R)&&(n.directional.length=p,n.spot.length=x,n.rectArea.length=m,n.point.length=_,n.hemi.length=d,n.directionalShadow.length=w,n.directionalShadowMap.length=w,n.pointShadow.length=b,n.pointShadowMap.length=b,n.spotShadow.length=M,n.spotShadowMap.length=M,n.directionalShadowMatrix.length=w,n.pointShadowMatrix.length=b,n.spotLightMatrix.length=M+P-A,n.spotLightMap.length=P,n.numSpotLightShadowsWithMaps=A,n.numLightProbes=R,L.directionalLength=p,L.pointLength=_,L.spotLength=x,L.rectAreaLength=m,L.hemiLength=d,L.numDirectionalShadows=w,L.numPointShadows=b,L.numSpotShadows=M,L.numSpotMaps=P,L.numLightProbes=R,n.version=Kg++)}function l(c,h){let u=0,f=0,p=0,_=0,x=0,m=h.matrixWorldInverse;for(let d=0,w=c.length;d<w;d++){let b=c[d];if(b.isDirectionalLight){let M=n.directional[u];M.direction.setFromMatrixPosition(b.matrixWorld),s.setFromMatrixPosition(b.target.matrixWorld),M.direction.sub(s),M.direction.transformDirection(m),u++}else if(b.isSpotLight){let M=n.spot[p];M.position.setFromMatrixPosition(b.matrixWorld),M.position.applyMatrix4(m),M.direction.setFromMatrixPosition(b.matrixWorld),s.setFromMatrixPosition(b.target.matrixWorld),M.direction.sub(s),M.direction.transformDirection(m),p++}else if(b.isRectAreaLight){let M=n.rectArea[_];M.position.setFromMatrixPosition(b.matrixWorld),M.position.applyMatrix4(m),a.identity(),r.copy(b.matrixWorld),r.premultiply(m),a.extractRotation(r),M.halfWidth.set(b.width*.5,0,0),M.halfHeight.set(0,b.height*.5,0),M.halfWidth.applyMatrix4(a),M.halfHeight.applyMatrix4(a),_++}else if(b.isPointLight){let M=n.point[f];M.position.setFromMatrixPosition(b.matrixWorld),M.position.applyMatrix4(m),f++}else if(b.isHemisphereLight){let M=n.hemi[x];M.direction.setFromMatrixPosition(b.matrixWorld),M.direction.transformDirection(m),x++}}}return{setup:o,setupView:l,state:n}}function lu(i){let t=new jg(i),e=[],n=[];function s(h){c.camera=h,e.length=0,n.length=0}function r(h){e.push(h)}function a(h){n.push(h)}function o(){t.setup(e)}function l(h){t.setupView(e,h)}let c={lightsArray:e,shadowsArray:n,camera:null,lights:t,transmissionRenderTarget:{}};return{init:s,state:c,setupLights:o,setupLightsView:l,pushLight:r,pushShadow:a}}function Qg(i){let t=new WeakMap;function e(s,r=0){let a=t.get(s),o;return a===void 0?(o=new lu(i),t.set(s,[o])):r>=a.length?(o=new lu(i),a.push(o)):o=a[r],o}function n(){t=new WeakMap}return{get:e,dispose:n}}var t0=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function n0(i,t,e){let n=new ts,s=new wt,r=new wt,a=new oe,o=new Jr({depthPacking:Eh}),l=new jr,c={},h=e.maxTextureSize,u={[Nn]:Te,[Te]:Nn,[an]:an},f=new Ve({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new wt},radius:{value:4}},vertexShader:t0,fragmentShader:e0}),p=f.clone();p.defines.HORIZONTAL_PASS=1;let _=new _e;_.setAttribute("position",new Le(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let x=new le(_,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=tl;let d=this.type;this.render=function(A,R,L){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||A.length===0)return;let y=i.getRenderTarget(),g=i.getActiveCubeFace(),T=i.getActiveMipmapLevel(),N=i.state;N.setBlending(On),N.buffers.color.setClear(1,1,1,1),N.buffers.depth.setTest(!0),N.setScissorTest(!1);let C=d!==bn&&this.type===bn,H=d===bn&&this.type!==bn;for(let G=0,X=A.length;G<X;G++){let Q=A[G],q=Q.shadow;if(q===void 0){console.warn("THREE.WebGLShadowMap:",Q,"has no shadow.");continue}if(q.autoUpdate===!1&&q.needsUpdate===!1)continue;s.copy(q.mapSize);let rt=q.getFrameExtents();if(s.multiply(rt),r.copy(q.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/rt.x),s.x=r.x*rt.x,q.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/rt.y),s.y=r.y*rt.y,q.mapSize.y=r.y)),q.map===null||C===!0||H===!0){let vt=this.type!==bn?{minFilter:nn,magFilter:nn}:{};q.map!==null&&q.map.dispose(),q.map=new Sn(s.x,s.y,vt),q.map.texture.name=Q.name+".shadowMap",q.camera.updateProjectionMatrix()}i.setRenderTarget(q.map),i.clear();let ut=q.getViewportCount();for(let vt=0;vt<ut;vt++){let Ot=q.getViewport(vt);a.set(r.x*Ot.x,r.y*Ot.y,r.x*Ot.z,r.y*Ot.w),N.viewport(a),q.updateMatrices(Q,vt),n=q.getFrustum(),M(R,L,q.camera,Q,this.type)}q.isPointLightShadow!==!0&&this.type===bn&&w(q,L),q.needsUpdate=!1}d=this.type,m.needsUpdate=!1,i.setRenderTarget(y,g,T)};function w(A,R){let L=t.update(x);f.defines.VSM_SAMPLES!==A.blurSamples&&(f.defines.VSM_SAMPLES=A.blurSamples,p.defines.VSM_SAMPLES=A.blurSamples,f.needsUpdate=!0,p.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new Sn(s.x,s.y)),f.uniforms.shadow_pass.value=A.map.texture,f.uniforms.resolution.value=A.mapSize,f.uniforms.radius.value=A.radius,i.setRenderTarget(A.mapPass),i.clear(),i.renderBufferDirect(R,null,L,f,x,null),p.uniforms.shadow_pass.value=A.mapPass.texture,p.uniforms.resolution.value=A.mapSize,p.uniforms.radius.value=A.radius,i.setRenderTarget(A.map),i.clear(),i.renderBufferDirect(R,null,L,p,x,null)}function b(A,R,L,y){let g=null,T=L.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(T!==void 0)g=T;else if(g=L.isPointLight===!0?l:o,i.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0){let N=g.uuid,C=R.uuid,H=c[N];H===void 0&&(H={},c[N]=H);let G=H[C];G===void 0&&(G=g.clone(),H[C]=G,R.addEventListener("dispose",P)),g=G}if(g.visible=R.visible,g.wireframe=R.wireframe,y===bn?g.side=R.shadowSide!==null?R.shadowSide:R.side:g.side=R.shadowSide!==null?R.shadowSide:u[R.side],g.alphaMap=R.alphaMap,g.alphaTest=R.alphaTest,g.map=R.map,g.clipShadows=R.clipShadows,g.clippingPlanes=R.clippingPlanes,g.clipIntersection=R.clipIntersection,g.displacementMap=R.displacementMap,g.displacementScale=R.displacementScale,g.displacementBias=R.displacementBias,g.wireframeLinewidth=R.wireframeLinewidth,g.linewidth=R.linewidth,L.isPointLight===!0&&g.isMeshDistanceMaterial===!0){let N=i.properties.get(g);N.light=L}return g}function M(A,R,L,y,g){if(A.visible===!1)return;if(A.layers.test(R.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&g===bn)&&(!A.frustumCulled||n.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(L.matrixWorldInverse,A.matrixWorld);let C=t.update(A),H=A.material;if(Array.isArray(H)){let G=C.groups;for(let X=0,Q=G.length;X<Q;X++){let q=G[X],rt=H[q.materialIndex];if(rt&&rt.visible){let ut=b(A,rt,y,g);A.onBeforeShadow(i,A,R,L,C,ut,q),i.renderBufferDirect(L,null,C,ut,A,q),A.onAfterShadow(i,A,R,L,C,ut,q)}}}else if(H.visible){let G=b(A,H,y,g);A.onBeforeShadow(i,A,R,L,C,G,null),i.renderBufferDirect(L,null,C,G,A,null),A.onAfterShadow(i,A,R,L,C,G,null)}}let N=A.children;for(let C=0,H=N.length;C<H;C++)M(N[C],R,L,y,g)}function P(A){A.target.removeEventListener("dispose",P);for(let L in c){let y=c[L],g=A.target.uuid;g in y&&(y[g].dispose(),delete y[g])}}}var i0={[ca]:ha,[ua]:pa,[da]:ma,[xi]:fa,[ha]:ca,[pa]:ua,[ma]:da,[fa]:xi};function s0(i,t){function e(){let D=!1,it=new oe,W=null,K=new oe(0,0,0,0);return{setMask:function(ct){W!==ct&&!D&&(i.colorMask(ct,ct,ct,ct),W=ct)},setLocked:function(ct){D=ct},setClear:function(ct,lt,Lt,he,Ce){Ce===!0&&(ct*=he,lt*=he,Lt*=he),it.set(ct,lt,Lt,he),K.equals(it)===!1&&(i.clearColor(ct,lt,Lt,he),K.copy(it))},reset:function(){D=!1,W=null,K.set(-1,0,0,0)}}}function n(){let D=!1,it=!1,W=null,K=null,ct=null;return{setReversed:function(lt){if(it!==lt){let Lt=t.get("EXT_clip_control");it?Lt.clipControlEXT(Lt.LOWER_LEFT_EXT,Lt.ZERO_TO_ONE_EXT):Lt.clipControlEXT(Lt.LOWER_LEFT_EXT,Lt.NEGATIVE_ONE_TO_ONE_EXT);let he=ct;ct=null,this.setClear(he)}it=lt},getReversed:function(){return it},setTest:function(lt){lt?at(i.DEPTH_TEST):Tt(i.DEPTH_TEST)},setMask:function(lt){W!==lt&&!D&&(i.depthMask(lt),W=lt)},setFunc:function(lt){if(it&&(lt=i0[lt]),K!==lt){switch(lt){case ca:i.depthFunc(i.NEVER);break;case ha:i.depthFunc(i.ALWAYS);break;case ua:i.depthFunc(i.LESS);break;case xi:i.depthFunc(i.LEQUAL);break;case da:i.depthFunc(i.EQUAL);break;case fa:i.depthFunc(i.GEQUAL);break;case pa:i.depthFunc(i.GREATER);break;case ma:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}K=lt}},setLocked:function(lt){D=lt},setClear:function(lt){ct!==lt&&(it&&(lt=1-lt),i.clearDepth(lt),ct=lt)},reset:function(){D=!1,W=null,K=null,ct=null,it=!1}}}function s(){let D=!1,it=null,W=null,K=null,ct=null,lt=null,Lt=null,he=null,Ce=null;return{setTest:function(Kt){D||(Kt?at(i.STENCIL_TEST):Tt(i.STENCIL_TEST))},setMask:function(Kt){it!==Kt&&!D&&(i.stencilMask(Kt),it=Kt)},setFunc:function(Kt,ln,Cn){(W!==Kt||K!==ln||ct!==Cn)&&(i.stencilFunc(Kt,ln,Cn),W=Kt,K=ln,ct=Cn)},setOp:function(Kt,ln,Cn){(lt!==Kt||Lt!==ln||he!==Cn)&&(i.stencilOp(Kt,ln,Cn),lt=Kt,Lt=ln,he=Cn)},setLocked:function(Kt){D=Kt},setClear:function(Kt){Ce!==Kt&&(i.clearStencil(Kt),Ce=Kt)},reset:function(){D=!1,it=null,W=null,K=null,ct=null,lt=null,Lt=null,he=null,Ce=null}}}let r=new e,a=new n,o=new s,l=new WeakMap,c=new WeakMap,h={},u={},f=new WeakMap,p=[],_=null,x=!1,m=null,d=null,w=null,b=null,M=null,P=null,A=null,R=new Ft(0,0,0),L=0,y=!1,g=null,T=null,N=null,C=null,H=null,G=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS),X=!1,Q=0,q=i.getParameter(i.VERSION);q.indexOf("WebGL")!==-1?(Q=parseFloat(/^WebGL (\d)/.exec(q)[1]),X=Q>=1):q.indexOf("OpenGL ES")!==-1&&(Q=parseFloat(/^OpenGL ES (\d)/.exec(q)[1]),X=Q>=2);let rt=null,ut={},vt=i.getParameter(i.SCISSOR_BOX),Ot=i.getParameter(i.VIEWPORT),Qt=new oe().fromArray(vt),$=new oe().fromArray(Ot);function et(D,it,W,K){let ct=new Uint8Array(4),lt=i.createTexture();i.bindTexture(D,lt),i.texParameteri(D,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(D,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Lt=0;Lt<W;Lt++)D===i.TEXTURE_3D||D===i.TEXTURE_2D_ARRAY?i.texImage3D(it,0,i.RGBA,1,1,K,0,i.RGBA,i.UNSIGNED_BYTE,ct):i.texImage2D(it+Lt,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ct);return lt}let _t={};_t[i.TEXTURE_2D]=et(i.TEXTURE_2D,i.TEXTURE_2D,1),_t[i.TEXTURE_CUBE_MAP]=et(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),_t[i.TEXTURE_2D_ARRAY]=et(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),_t[i.TEXTURE_3D]=et(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),at(i.DEPTH_TEST),a.setFunc(xi),zt(!1),kt(Qo),at(i.CULL_FACE),I(On);function at(D){h[D]!==!0&&(i.enable(D),h[D]=!0)}function Tt(D){h[D]!==!1&&(i.disable(D),h[D]=!1)}function Pt(D,it){return u[D]!==it?(i.bindFramebuffer(D,it),u[D]=it,D===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=it),D===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=it),!0):!1}function Bt(D,it){let W=p,K=!1;if(D){W=f.get(it),W===void 0&&(W=[],f.set(it,W));let ct=D.textures;if(W.length!==ct.length||W[0]!==i.COLOR_ATTACHMENT0){for(let lt=0,Lt=ct.length;lt<Lt;lt++)W[lt]=i.COLOR_ATTACHMENT0+lt;W.length=ct.length,K=!0}}else W[0]!==i.BACK&&(W[0]=i.BACK,K=!0);K&&i.drawBuffers(W)}function ae(D){return _!==D?(i.useProgram(D),_=D,!0):!1}let Vt={[jn]:i.FUNC_ADD,[Jc]:i.FUNC_SUBTRACT,[jc]:i.FUNC_REVERSE_SUBTRACT};Vt[Qc]=i.MIN,Vt[th]=i.MAX;let fe={[eh]:i.ZERO,[nh]:i.ONE,[ih]:i.SRC_COLOR,[Br]:i.SRC_ALPHA,[ch]:i.SRC_ALPHA_SATURATE,[oh]:i.DST_COLOR,[rh]:i.DST_ALPHA,[sh]:i.ONE_MINUS_SRC_COLOR,[zr]:i.ONE_MINUS_SRC_ALPHA,[lh]:i.ONE_MINUS_DST_COLOR,[ah]:i.ONE_MINUS_DST_ALPHA,[hh]:i.CONSTANT_COLOR,[uh]:i.ONE_MINUS_CONSTANT_COLOR,[dh]:i.CONSTANT_ALPHA,[fh]:i.ONE_MINUS_CONSTANT_ALPHA};function I(D,it,W,K,ct,lt,Lt,he,Ce,Kt){if(D===On){x===!0&&(Tt(i.BLEND),x=!1);return}if(x===!1&&(at(i.BLEND),x=!0),D!==Kc){if(D!==m||Kt!==y){if((d!==jn||M!==jn)&&(i.blendEquation(i.FUNC_ADD),d=jn,M=jn),Kt)switch(D){case vi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Zs:i.blendFunc(i.ONE,i.ONE);break;case el:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case nl:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}else switch(D){case vi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Zs:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case el:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case nl:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}w=null,b=null,P=null,A=null,R.set(0,0,0),L=0,m=D,y=Kt}return}ct=ct||it,lt=lt||W,Lt=Lt||K,(it!==d||ct!==M)&&(i.blendEquationSeparate(Vt[it],Vt[ct]),d=it,M=ct),(W!==w||K!==b||lt!==P||Lt!==A)&&(i.blendFuncSeparate(fe[W],fe[K],fe[lt],fe[Lt]),w=W,b=K,P=lt,A=Lt),(he.equals(R)===!1||Ce!==L)&&(i.blendColor(he.r,he.g,he.b,Ce),R.copy(he),L=Ce),m=D,y=!1}function Je(D,it){D.side===an?Tt(i.CULL_FACE):at(i.CULL_FACE);let W=D.side===Te;it&&(W=!W),zt(W),D.blending===vi&&D.transparent===!1?I(On):I(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),a.setFunc(D.depthFunc),a.setTest(D.depthTest),a.setMask(D.depthWrite),r.setMask(D.colorWrite);let K=D.stencilWrite;o.setTest(K),K&&(o.setMask(D.stencilWriteMask),o.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),o.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),ee(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?at(i.SAMPLE_ALPHA_TO_COVERAGE):Tt(i.SAMPLE_ALPHA_TO_COVERAGE)}function zt(D){g!==D&&(D?i.frontFace(i.CW):i.frontFace(i.CCW),g=D)}function kt(D){D!==Yc?(at(i.CULL_FACE),D!==T&&(D===Qo?i.cullFace(i.BACK):D===$c?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Tt(i.CULL_FACE),T=D}function xt(D){D!==N&&(X&&i.lineWidth(D),N=D)}function ee(D,it,W){D?(at(i.POLYGON_OFFSET_FILL),(C!==it||H!==W)&&(i.polygonOffset(it,W),C=it,H=W)):Tt(i.POLYGON_OFFSET_FILL)}function St(D){D?at(i.SCISSOR_TEST):Tt(i.SCISSOR_TEST)}function E(D){D===void 0&&(D=i.TEXTURE0+G-1),rt!==D&&(i.activeTexture(D),rt=D)}function v(D,it,W){W===void 0&&(rt===null?W=i.TEXTURE0+G-1:W=rt);let K=ut[W];K===void 0&&(K={type:void 0,texture:void 0},ut[W]=K),(K.type!==D||K.texture!==it)&&(rt!==W&&(i.activeTexture(W),rt=W),i.bindTexture(D,it||_t[D]),K.type=D,K.texture=it)}function B(){let D=ut[rt];D!==void 0&&D.type!==void 0&&(i.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function Z(){try{i.compressedTexImage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function J(){try{i.compressedTexImage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Y(){try{i.texSubImage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function yt(){try{i.texSubImage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ot(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function dt(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Gt(){try{i.texStorage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function tt(){try{i.texStorage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ft(){try{i.texImage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Et(){try{i.texImage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function At(D){Qt.equals(D)===!1&&(i.scissor(D.x,D.y,D.z,D.w),Qt.copy(D))}function pt(D){$.equals(D)===!1&&(i.viewport(D.x,D.y,D.z,D.w),$.copy(D))}function Ht(D,it){let W=c.get(it);W===void 0&&(W=new WeakMap,c.set(it,W));let K=W.get(D);K===void 0&&(K=i.getUniformBlockIndex(it,D.name),W.set(D,K))}function Dt(D,it){let K=c.get(it).get(D);l.get(it)!==K&&(i.uniformBlockBinding(it,K,D.__bindingPointIndex),l.set(it,K))}function te(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),h={},rt=null,ut={},u={},f=new WeakMap,p=[],_=null,x=!1,m=null,d=null,w=null,b=null,M=null,P=null,A=null,R=new Ft(0,0,0),L=0,y=!1,g=null,T=null,N=null,C=null,H=null,Qt.set(0,0,i.canvas.width,i.canvas.height),$.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:at,disable:Tt,bindFramebuffer:Pt,drawBuffers:Bt,useProgram:ae,setBlending:I,setMaterial:Je,setFlipSided:zt,setCullFace:kt,setLineWidth:xt,setPolygonOffset:ee,setScissorTest:St,activeTexture:E,bindTexture:v,unbindTexture:B,compressedTexImage2D:Z,compressedTexImage3D:J,texImage2D:ft,texImage3D:Et,updateUBOMapping:Ht,uniformBlockBinding:Dt,texStorage2D:Gt,texStorage3D:tt,texSubImage2D:Y,texSubImage3D:yt,compressedTexSubImage2D:ot,compressedTexSubImage3D:dt,scissor:At,viewport:pt,reset:te}}function r0(i,t,e,n,s,r,a){let o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new wt,h=new WeakMap,u,f=new WeakMap,p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(E,v){return p?new OffscreenCanvas(E,v):Ji("canvas")}function x(E,v,B){let Z=1,J=St(E);if((J.width>B||J.height>B)&&(Z=B/Math.max(J.width,J.height)),Z<1)if(typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&E instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&E instanceof ImageBitmap||typeof VideoFrame<"u"&&E instanceof VideoFrame){let Y=Math.floor(Z*J.width),yt=Math.floor(Z*J.height);u===void 0&&(u=_(Y,yt));let ot=v?_(Y,yt):u;return ot.width=Y,ot.height=yt,ot.getContext("2d").drawImage(E,0,0,Y,yt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+Y+"x"+yt+")."),ot}else return"data"in E&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),E;return E}function m(E){return E.generateMipmaps}function d(E){i.generateMipmap(E)}function w(E){return E.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:E.isWebGL3DRenderTarget?i.TEXTURE_3D:E.isWebGLArrayRenderTarget||E.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function b(E,v,B,Z,J=!1){if(E!==null){if(i[E]!==void 0)return i[E];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let Y=v;if(v===i.RED&&(B===i.FLOAT&&(Y=i.R32F),B===i.HALF_FLOAT&&(Y=i.R16F),B===i.UNSIGNED_BYTE&&(Y=i.R8)),v===i.RED_INTEGER&&(B===i.UNSIGNED_BYTE&&(Y=i.R8UI),B===i.UNSIGNED_SHORT&&(Y=i.R16UI),B===i.UNSIGNED_INT&&(Y=i.R32UI),B===i.BYTE&&(Y=i.R8I),B===i.SHORT&&(Y=i.R16I),B===i.INT&&(Y=i.R32I)),v===i.RG&&(B===i.FLOAT&&(Y=i.RG32F),B===i.HALF_FLOAT&&(Y=i.RG16F),B===i.UNSIGNED_BYTE&&(Y=i.RG8)),v===i.RG_INTEGER&&(B===i.UNSIGNED_BYTE&&(Y=i.RG8UI),B===i.UNSIGNED_SHORT&&(Y=i.RG16UI),B===i.UNSIGNED_INT&&(Y=i.RG32UI),B===i.BYTE&&(Y=i.RG8I),B===i.SHORT&&(Y=i.RG16I),B===i.INT&&(Y=i.RG32I)),v===i.RGB_INTEGER&&(B===i.UNSIGNED_BYTE&&(Y=i.RGB8UI),B===i.UNSIGNED_SHORT&&(Y=i.RGB16UI),B===i.UNSIGNED_INT&&(Y=i.RGB32UI),B===i.BYTE&&(Y=i.RGB8I),B===i.SHORT&&(Y=i.RGB16I),B===i.INT&&(Y=i.RGB32I)),v===i.RGBA_INTEGER&&(B===i.UNSIGNED_BYTE&&(Y=i.RGBA8UI),B===i.UNSIGNED_SHORT&&(Y=i.RGBA16UI),B===i.UNSIGNED_INT&&(Y=i.RGBA32UI),B===i.BYTE&&(Y=i.RGBA8I),B===i.SHORT&&(Y=i.RGBA16I),B===i.INT&&(Y=i.RGBA32I)),v===i.RGB&&B===i.UNSIGNED_INT_5_9_9_9_REV&&(Y=i.RGB9_E5),v===i.RGBA){let yt=J?Ts:Xt.getTransfer(Z);B===i.FLOAT&&(Y=i.RGBA32F),B===i.HALF_FLOAT&&(Y=i.RGBA16F),B===i.UNSIGNED_BYTE&&(Y=yt===Jt?i.SRGB8_ALPHA8:i.RGBA8),B===i.UNSIGNED_SHORT_4_4_4_4&&(Y=i.RGBA4),B===i.UNSIGNED_SHORT_5_5_5_1&&(Y=i.RGB5_A1)}return(Y===i.R16F||Y===i.R32F||Y===i.RG16F||Y===i.RG32F||Y===i.RGBA16F||Y===i.RGBA32F)&&t.get("EXT_color_buffer_float"),Y}function M(E,v){let B;return E?v===null||v===li||v===Ti?B=i.DEPTH24_STENCIL8:v===wn?B=i.DEPTH32F_STENCIL8:v===as&&(B=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===li||v===Ti?B=i.DEPTH_COMPONENT24:v===wn?B=i.DEPTH_COMPONENT32F:v===as&&(B=i.DEPTH_COMPONENT16),B}function P(E,v){return m(E)===!0||E.isFramebufferTexture&&E.minFilter!==nn&&E.minFilter!==fn?Math.log2(Math.max(v.width,v.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?v.mipmaps.length:1}function A(E){let v=E.target;v.removeEventListener("dispose",A),L(v),v.isVideoTexture&&h.delete(v)}function R(E){let v=E.target;v.removeEventListener("dispose",R),g(v)}function L(E){let v=n.get(E);if(v.__webglInit===void 0)return;let B=E.source,Z=f.get(B);if(Z){let J=Z[v.__cacheKey];J.usedTimes--,J.usedTimes===0&&y(E),Object.keys(Z).length===0&&f.delete(B)}n.remove(E)}function y(E){let v=n.get(E);i.deleteTexture(v.__webglTexture);let B=E.source,Z=f.get(B);delete Z[v.__cacheKey],a.memory.textures--}function g(E){let v=n.get(E);if(E.depthTexture&&(E.depthTexture.dispose(),n.remove(E.depthTexture)),E.isWebGLCubeRenderTarget)for(let Z=0;Z<6;Z++){if(Array.isArray(v.__webglFramebuffer[Z]))for(let J=0;J<v.__webglFramebuffer[Z].length;J++)i.deleteFramebuffer(v.__webglFramebuffer[Z][J]);else i.deleteFramebuffer(v.__webglFramebuffer[Z]);v.__webglDepthbuffer&&i.deleteRenderbuffer(v.__webglDepthbuffer[Z])}else{if(Array.isArray(v.__webglFramebuffer))for(let Z=0;Z<v.__webglFramebuffer.length;Z++)i.deleteFramebuffer(v.__webglFramebuffer[Z]);else i.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&i.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&i.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let Z=0;Z<v.__webglColorRenderbuffer.length;Z++)v.__webglColorRenderbuffer[Z]&&i.deleteRenderbuffer(v.__webglColorRenderbuffer[Z]);v.__webglDepthRenderbuffer&&i.deleteRenderbuffer(v.__webglDepthRenderbuffer)}let B=E.textures;for(let Z=0,J=B.length;Z<J;Z++){let Y=n.get(B[Z]);Y.__webglTexture&&(i.deleteTexture(Y.__webglTexture),a.memory.textures--),n.remove(B[Z])}n.remove(E)}let T=0;function N(){T=0}function C(){let E=T;return E>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+E+" texture units while this GPU supports only "+s.maxTextures),T+=1,E}function H(E){let v=[];return v.push(E.wrapS),v.push(E.wrapT),v.push(E.wrapR||0),v.push(E.magFilter),v.push(E.minFilter),v.push(E.anisotropy),v.push(E.internalFormat),v.push(E.format),v.push(E.type),v.push(E.generateMipmaps),v.push(E.premultiplyAlpha),v.push(E.flipY),v.push(E.unpackAlignment),v.push(E.colorSpace),v.join()}function G(E,v){let B=n.get(E);if(E.isVideoTexture&&xt(E),E.isRenderTargetTexture===!1&&E.version>0&&B.__version!==E.version){let Z=E.image;if(Z===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Z.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{$(B,E,v);return}}e.bindTexture(i.TEXTURE_2D,B.__webglTexture,i.TEXTURE0+v)}function X(E,v){let B=n.get(E);if(E.version>0&&B.__version!==E.version){$(B,E,v);return}e.bindTexture(i.TEXTURE_2D_ARRAY,B.__webglTexture,i.TEXTURE0+v)}function Q(E,v){let B=n.get(E);if(E.version>0&&B.__version!==E.version){$(B,E,v);return}e.bindTexture(i.TEXTURE_3D,B.__webglTexture,i.TEXTURE0+v)}function q(E,v){let B=n.get(E);if(E.version>0&&B.__version!==E.version){et(B,E,v);return}e.bindTexture(i.TEXTURE_CUBE_MAP,B.__webglTexture,i.TEXTURE0+v)}let rt={[kr]:i.REPEAT,[Jn]:i.CLAMP_TO_EDGE,[Hr]:i.MIRRORED_REPEAT},ut={[nn]:i.NEAREST,[Mh]:i.NEAREST_MIPMAP_NEAREST,[Js]:i.NEAREST_MIPMAP_LINEAR,[fn]:i.LINEAR,[xa]:i.LINEAR_MIPMAP_NEAREST,[oi]:i.LINEAR_MIPMAP_LINEAR},vt={[Th]:i.NEVER,[Lh]:i.ALWAYS,[Ah]:i.LESS,[ml]:i.LEQUAL,[Ch]:i.EQUAL,[Ih]:i.GEQUAL,[Rh]:i.GREATER,[Ph]:i.NOTEQUAL};function Ot(E,v){if(v.type===wn&&t.has("OES_texture_float_linear")===!1&&(v.magFilter===fn||v.magFilter===xa||v.magFilter===Js||v.magFilter===oi||v.minFilter===fn||v.minFilter===xa||v.minFilter===Js||v.minFilter===oi)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(E,i.TEXTURE_WRAP_S,rt[v.wrapS]),i.texParameteri(E,i.TEXTURE_WRAP_T,rt[v.wrapT]),(E===i.TEXTURE_3D||E===i.TEXTURE_2D_ARRAY)&&i.texParameteri(E,i.TEXTURE_WRAP_R,rt[v.wrapR]),i.texParameteri(E,i.TEXTURE_MAG_FILTER,ut[v.magFilter]),i.texParameteri(E,i.TEXTURE_MIN_FILTER,ut[v.minFilter]),v.compareFunction&&(i.texParameteri(E,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(E,i.TEXTURE_COMPARE_FUNC,vt[v.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===nn||v.minFilter!==Js&&v.minFilter!==oi||v.type===wn&&t.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||n.get(v).__currentAnisotropy){let B=t.get("EXT_texture_filter_anisotropic");i.texParameterf(E,B.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,s.getMaxAnisotropy())),n.get(v).__currentAnisotropy=v.anisotropy}}}function Qt(E,v){let B=!1;E.__webglInit===void 0&&(E.__webglInit=!0,v.addEventListener("dispose",A));let Z=v.source,J=f.get(Z);J===void 0&&(J={},f.set(Z,J));let Y=H(v);if(Y!==E.__cacheKey){J[Y]===void 0&&(J[Y]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,B=!0),J[Y].usedTimes++;let yt=J[E.__cacheKey];yt!==void 0&&(J[E.__cacheKey].usedTimes--,yt.usedTimes===0&&y(v)),E.__cacheKey=Y,E.__webglTexture=J[Y].texture}return B}function $(E,v,B){let Z=i.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(Z=i.TEXTURE_2D_ARRAY),v.isData3DTexture&&(Z=i.TEXTURE_3D);let J=Qt(E,v),Y=v.source;e.bindTexture(Z,E.__webglTexture,i.TEXTURE0+B);let yt=n.get(Y);if(Y.version!==yt.__version||J===!0){e.activeTexture(i.TEXTURE0+B);let ot=Xt.getPrimaries(Xt.workingColorSpace),dt=v.colorSpace===zn?null:Xt.getPrimaries(v.colorSpace),Gt=v.colorSpace===zn||ot===dt?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,v.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,v.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Gt);let tt=x(v.image,!1,s.maxTextureSize);tt=ee(v,tt);let ft=r.convert(v.format,v.colorSpace),Et=r.convert(v.type),At=b(v.internalFormat,ft,Et,v.colorSpace,v.isVideoTexture);Ot(Z,v);let pt,Ht=v.mipmaps,Dt=v.isVideoTexture!==!0,te=yt.__version===void 0||J===!0,D=Y.dataReady,it=P(v,tt);if(v.isDepthTexture)At=M(v.format===Si,v.type),te&&(Dt?e.texStorage2D(i.TEXTURE_2D,1,At,tt.width,tt.height):e.texImage2D(i.TEXTURE_2D,0,At,tt.width,tt.height,0,ft,Et,null));else if(v.isDataTexture)if(Ht.length>0){Dt&&te&&e.texStorage2D(i.TEXTURE_2D,it,At,Ht[0].width,Ht[0].height);for(let W=0,K=Ht.length;W<K;W++)pt=Ht[W],Dt?D&&e.texSubImage2D(i.TEXTURE_2D,W,0,0,pt.width,pt.height,ft,Et,pt.data):e.texImage2D(i.TEXTURE_2D,W,At,pt.width,pt.height,0,ft,Et,pt.data);v.generateMipmaps=!1}else Dt?(te&&e.texStorage2D(i.TEXTURE_2D,it,At,tt.width,tt.height),D&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,tt.width,tt.height,ft,Et,tt.data)):e.texImage2D(i.TEXTURE_2D,0,At,tt.width,tt.height,0,ft,Et,tt.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){Dt&&te&&e.texStorage3D(i.TEXTURE_2D_ARRAY,it,At,Ht[0].width,Ht[0].height,tt.depth);for(let W=0,K=Ht.length;W<K;W++)if(pt=Ht[W],v.format!==on)if(ft!==null)if(Dt){if(D)if(v.layerUpdates.size>0){let ct=bl(pt.width,pt.height,v.format,v.type);for(let lt of v.layerUpdates){let Lt=pt.data.subarray(lt*ct/pt.data.BYTES_PER_ELEMENT,(lt+1)*ct/pt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,W,0,0,lt,pt.width,pt.height,1,ft,Lt)}v.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,W,0,0,0,pt.width,pt.height,tt.depth,ft,pt.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,W,At,pt.width,pt.height,tt.depth,0,pt.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Dt?D&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,W,0,0,0,pt.width,pt.height,tt.depth,ft,Et,pt.data):e.texImage3D(i.TEXTURE_2D_ARRAY,W,At,pt.width,pt.height,tt.depth,0,ft,Et,pt.data)}else{Dt&&te&&e.texStorage2D(i.TEXTURE_2D,it,At,Ht[0].width,Ht[0].height);for(let W=0,K=Ht.length;W<K;W++)pt=Ht[W],v.format!==on?ft!==null?Dt?D&&e.compressedTexSubImage2D(i.TEXTURE_2D,W,0,0,pt.width,pt.height,ft,pt.data):e.compressedTexImage2D(i.TEXTURE_2D,W,At,pt.width,pt.height,0,pt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Dt?D&&e.texSubImage2D(i.TEXTURE_2D,W,0,0,pt.width,pt.height,ft,Et,pt.data):e.texImage2D(i.TEXTURE_2D,W,At,pt.width,pt.height,0,ft,Et,pt.data)}else if(v.isDataArrayTexture)if(Dt){if(te&&e.texStorage3D(i.TEXTURE_2D_ARRAY,it,At,tt.width,tt.height,tt.depth),D)if(v.layerUpdates.size>0){let W=bl(tt.width,tt.height,v.format,v.type);for(let K of v.layerUpdates){let ct=tt.data.subarray(K*W/tt.data.BYTES_PER_ELEMENT,(K+1)*W/tt.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,K,tt.width,tt.height,1,ft,Et,ct)}v.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,tt.width,tt.height,tt.depth,ft,Et,tt.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,At,tt.width,tt.height,tt.depth,0,ft,Et,tt.data);else if(v.isData3DTexture)Dt?(te&&e.texStorage3D(i.TEXTURE_3D,it,At,tt.width,tt.height,tt.depth),D&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,tt.width,tt.height,tt.depth,ft,Et,tt.data)):e.texImage3D(i.TEXTURE_3D,0,At,tt.width,tt.height,tt.depth,0,ft,Et,tt.data);else if(v.isFramebufferTexture){if(te)if(Dt)e.texStorage2D(i.TEXTURE_2D,it,At,tt.width,tt.height);else{let W=tt.width,K=tt.height;for(let ct=0;ct<it;ct++)e.texImage2D(i.TEXTURE_2D,ct,At,W,K,0,ft,Et,null),W>>=1,K>>=1}}else if(Ht.length>0){if(Dt&&te){let W=St(Ht[0]);e.texStorage2D(i.TEXTURE_2D,it,At,W.width,W.height)}for(let W=0,K=Ht.length;W<K;W++)pt=Ht[W],Dt?D&&e.texSubImage2D(i.TEXTURE_2D,W,0,0,ft,Et,pt):e.texImage2D(i.TEXTURE_2D,W,At,ft,Et,pt);v.generateMipmaps=!1}else if(Dt){if(te){let W=St(tt);e.texStorage2D(i.TEXTURE_2D,it,At,W.width,W.height)}D&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,ft,Et,tt)}else e.texImage2D(i.TEXTURE_2D,0,At,ft,Et,tt);m(v)&&d(Z),yt.__version=Y.version,v.onUpdate&&v.onUpdate(v)}E.__version=v.version}function et(E,v,B){if(v.image.length!==6)return;let Z=Qt(E,v),J=v.source;e.bindTexture(i.TEXTURE_CUBE_MAP,E.__webglTexture,i.TEXTURE0+B);let Y=n.get(J);if(J.version!==Y.__version||Z===!0){e.activeTexture(i.TEXTURE0+B);let yt=Xt.getPrimaries(Xt.workingColorSpace),ot=v.colorSpace===zn?null:Xt.getPrimaries(v.colorSpace),dt=v.colorSpace===zn||yt===ot?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,v.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,v.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,dt);let Gt=v.isCompressedTexture||v.image[0].isCompressedTexture,tt=v.image[0]&&v.image[0].isDataTexture,ft=[];for(let K=0;K<6;K++)!Gt&&!tt?ft[K]=x(v.image[K],!0,s.maxCubemapSize):ft[K]=tt?v.image[K].image:v.image[K],ft[K]=ee(v,ft[K]);let Et=ft[0],At=r.convert(v.format,v.colorSpace),pt=r.convert(v.type),Ht=b(v.internalFormat,At,pt,v.colorSpace),Dt=v.isVideoTexture!==!0,te=Y.__version===void 0||Z===!0,D=J.dataReady,it=P(v,Et);Ot(i.TEXTURE_CUBE_MAP,v);let W;if(Gt){Dt&&te&&e.texStorage2D(i.TEXTURE_CUBE_MAP,it,Ht,Et.width,Et.height);for(let K=0;K<6;K++){W=ft[K].mipmaps;for(let ct=0;ct<W.length;ct++){let lt=W[ct];v.format!==on?At!==null?Dt?D&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ct,0,0,lt.width,lt.height,At,lt.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ct,Ht,lt.width,lt.height,0,lt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Dt?D&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ct,0,0,lt.width,lt.height,At,pt,lt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ct,Ht,lt.width,lt.height,0,At,pt,lt.data)}}}else{if(W=v.mipmaps,Dt&&te){W.length>0&&it++;let K=St(ft[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,it,Ht,K.width,K.height)}for(let K=0;K<6;K++)if(tt){Dt?D&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,ft[K].width,ft[K].height,At,pt,ft[K].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Ht,ft[K].width,ft[K].height,0,At,pt,ft[K].data);for(let ct=0;ct<W.length;ct++){let Lt=W[ct].image[K].image;Dt?D&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ct+1,0,0,Lt.width,Lt.height,At,pt,Lt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ct+1,Ht,Lt.width,Lt.height,0,At,pt,Lt.data)}}else{Dt?D&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,At,pt,ft[K]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Ht,At,pt,ft[K]);for(let ct=0;ct<W.length;ct++){let lt=W[ct];Dt?D&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ct+1,0,0,At,pt,lt.image[K]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ct+1,Ht,At,pt,lt.image[K])}}}m(v)&&d(i.TEXTURE_CUBE_MAP),Y.__version=J.version,v.onUpdate&&v.onUpdate(v)}E.__version=v.version}function _t(E,v,B,Z,J,Y){let yt=r.convert(B.format,B.colorSpace),ot=r.convert(B.type),dt=b(B.internalFormat,yt,ot,B.colorSpace),Gt=n.get(v),tt=n.get(B);if(tt.__renderTarget=v,!Gt.__hasExternalTextures){let ft=Math.max(1,v.width>>Y),Et=Math.max(1,v.height>>Y);J===i.TEXTURE_3D||J===i.TEXTURE_2D_ARRAY?e.texImage3D(J,Y,dt,ft,Et,v.depth,0,yt,ot,null):e.texImage2D(J,Y,dt,ft,Et,0,yt,ot,null)}e.bindFramebuffer(i.FRAMEBUFFER,E),kt(v)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Z,J,tt.__webglTexture,0,zt(v)):(J===i.TEXTURE_2D||J>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,Z,J,tt.__webglTexture,Y),e.bindFramebuffer(i.FRAMEBUFFER,null)}function at(E,v,B){if(i.bindRenderbuffer(i.RENDERBUFFER,E),v.depthBuffer){let Z=v.depthTexture,J=Z&&Z.isDepthTexture?Z.type:null,Y=M(v.stencilBuffer,J),yt=v.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ot=zt(v);kt(v)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ot,Y,v.width,v.height):B?i.renderbufferStorageMultisample(i.RENDERBUFFER,ot,Y,v.width,v.height):i.renderbufferStorage(i.RENDERBUFFER,Y,v.width,v.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,yt,i.RENDERBUFFER,E)}else{let Z=v.textures;for(let J=0;J<Z.length;J++){let Y=Z[J],yt=r.convert(Y.format,Y.colorSpace),ot=r.convert(Y.type),dt=b(Y.internalFormat,yt,ot,Y.colorSpace),Gt=zt(v);B&&kt(v)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Gt,dt,v.width,v.height):kt(v)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Gt,dt,v.width,v.height):i.renderbufferStorage(i.RENDERBUFFER,dt,v.width,v.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Tt(E,v){if(v&&v.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(i.FRAMEBUFFER,E),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");let Z=n.get(v.depthTexture);Z.__renderTarget=v,(!Z.__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),G(v.depthTexture,0);let J=Z.__webglTexture,Y=zt(v);if(v.depthTexture.format===yi)kt(v)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,J,0,Y):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,J,0);else if(v.depthTexture.format===Si)kt(v)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,J,0,Y):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,J,0);else throw new Error("Unknown depthTexture format")}function Pt(E){let v=n.get(E),B=E.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==E.depthTexture){let Z=E.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),Z){let J=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,Z.removeEventListener("dispose",J)};Z.addEventListener("dispose",J),v.__depthDisposeCallback=J}v.__boundDepthTexture=Z}if(E.depthTexture&&!v.__autoAllocateDepthBuffer){if(B)throw new Error("target.depthTexture not supported in Cube render targets");Tt(v.__webglFramebuffer,E)}else if(B){v.__webglDepthbuffer=[];for(let Z=0;Z<6;Z++)if(e.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer[Z]),v.__webglDepthbuffer[Z]===void 0)v.__webglDepthbuffer[Z]=i.createRenderbuffer(),at(v.__webglDepthbuffer[Z],E,!1);else{let J=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Y=v.__webglDepthbuffer[Z];i.bindRenderbuffer(i.RENDERBUFFER,Y),i.framebufferRenderbuffer(i.FRAMEBUFFER,J,i.RENDERBUFFER,Y)}}else if(e.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=i.createRenderbuffer(),at(v.__webglDepthbuffer,E,!1);else{let Z=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,J=v.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,J),i.framebufferRenderbuffer(i.FRAMEBUFFER,Z,i.RENDERBUFFER,J)}e.bindFramebuffer(i.FRAMEBUFFER,null)}function Bt(E,v,B){let Z=n.get(E);v!==void 0&&_t(Z.__webglFramebuffer,E,E.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),B!==void 0&&Pt(E)}function ae(E){let v=E.texture,B=n.get(E),Z=n.get(v);E.addEventListener("dispose",R);let J=E.textures,Y=E.isWebGLCubeRenderTarget===!0,yt=J.length>1;if(yt||(Z.__webglTexture===void 0&&(Z.__webglTexture=i.createTexture()),Z.__version=v.version,a.memory.textures++),Y){B.__webglFramebuffer=[];for(let ot=0;ot<6;ot++)if(v.mipmaps&&v.mipmaps.length>0){B.__webglFramebuffer[ot]=[];for(let dt=0;dt<v.mipmaps.length;dt++)B.__webglFramebuffer[ot][dt]=i.createFramebuffer()}else B.__webglFramebuffer[ot]=i.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){B.__webglFramebuffer=[];for(let ot=0;ot<v.mipmaps.length;ot++)B.__webglFramebuffer[ot]=i.createFramebuffer()}else B.__webglFramebuffer=i.createFramebuffer();if(yt)for(let ot=0,dt=J.length;ot<dt;ot++){let Gt=n.get(J[ot]);Gt.__webglTexture===void 0&&(Gt.__webglTexture=i.createTexture(),a.memory.textures++)}if(E.samples>0&&kt(E)===!1){B.__webglMultisampledFramebuffer=i.createFramebuffer(),B.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,B.__webglMultisampledFramebuffer);for(let ot=0;ot<J.length;ot++){let dt=J[ot];B.__webglColorRenderbuffer[ot]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,B.__webglColorRenderbuffer[ot]);let Gt=r.convert(dt.format,dt.colorSpace),tt=r.convert(dt.type),ft=b(dt.internalFormat,Gt,tt,dt.colorSpace,E.isXRRenderTarget===!0),Et=zt(E);i.renderbufferStorageMultisample(i.RENDERBUFFER,Et,ft,E.width,E.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ot,i.RENDERBUFFER,B.__webglColorRenderbuffer[ot])}i.bindRenderbuffer(i.RENDERBUFFER,null),E.depthBuffer&&(B.__webglDepthRenderbuffer=i.createRenderbuffer(),at(B.__webglDepthRenderbuffer,E,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(Y){e.bindTexture(i.TEXTURE_CUBE_MAP,Z.__webglTexture),Ot(i.TEXTURE_CUBE_MAP,v);for(let ot=0;ot<6;ot++)if(v.mipmaps&&v.mipmaps.length>0)for(let dt=0;dt<v.mipmaps.length;dt++)_t(B.__webglFramebuffer[ot][dt],E,v,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ot,dt);else _t(B.__webglFramebuffer[ot],E,v,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ot,0);m(v)&&d(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(yt){for(let ot=0,dt=J.length;ot<dt;ot++){let Gt=J[ot],tt=n.get(Gt);e.bindTexture(i.TEXTURE_2D,tt.__webglTexture),Ot(i.TEXTURE_2D,Gt),_t(B.__webglFramebuffer,E,Gt,i.COLOR_ATTACHMENT0+ot,i.TEXTURE_2D,0),m(Gt)&&d(i.TEXTURE_2D)}e.unbindTexture()}else{let ot=i.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(ot=E.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(ot,Z.__webglTexture),Ot(ot,v),v.mipmaps&&v.mipmaps.length>0)for(let dt=0;dt<v.mipmaps.length;dt++)_t(B.__webglFramebuffer[dt],E,v,i.COLOR_ATTACHMENT0,ot,dt);else _t(B.__webglFramebuffer,E,v,i.COLOR_ATTACHMENT0,ot,0);m(v)&&d(ot),e.unbindTexture()}E.depthBuffer&&Pt(E)}function Vt(E){let v=E.textures;for(let B=0,Z=v.length;B<Z;B++){let J=v[B];if(m(J)){let Y=w(E),yt=n.get(J).__webglTexture;e.bindTexture(Y,yt),d(Y),e.unbindTexture()}}}let fe=[],I=[];function Je(E){if(E.samples>0){if(kt(E)===!1){let v=E.textures,B=E.width,Z=E.height,J=i.COLOR_BUFFER_BIT,Y=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,yt=n.get(E),ot=v.length>1;if(ot)for(let dt=0;dt<v.length;dt++)e.bindFramebuffer(i.FRAMEBUFFER,yt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+dt,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,yt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+dt,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,yt.__webglMultisampledFramebuffer),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,yt.__webglFramebuffer);for(let dt=0;dt<v.length;dt++){if(E.resolveDepthBuffer&&(E.depthBuffer&&(J|=i.DEPTH_BUFFER_BIT),E.stencilBuffer&&E.resolveStencilBuffer&&(J|=i.STENCIL_BUFFER_BIT)),ot){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,yt.__webglColorRenderbuffer[dt]);let Gt=n.get(v[dt]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Gt,0)}i.blitFramebuffer(0,0,B,Z,0,0,B,Z,J,i.NEAREST),l===!0&&(fe.length=0,I.length=0,fe.push(i.COLOR_ATTACHMENT0+dt),E.depthBuffer&&E.resolveDepthBuffer===!1&&(fe.push(Y),I.push(Y),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,I)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,fe))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ot)for(let dt=0;dt<v.length;dt++){e.bindFramebuffer(i.FRAMEBUFFER,yt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+dt,i.RENDERBUFFER,yt.__webglColorRenderbuffer[dt]);let Gt=n.get(v[dt]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,yt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+dt,i.TEXTURE_2D,Gt,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,yt.__webglMultisampledFramebuffer)}else if(E.depthBuffer&&E.resolveDepthBuffer===!1&&l){let v=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[v])}}}function zt(E){return Math.min(s.maxSamples,E.samples)}function kt(E){let v=n.get(E);return E.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function xt(E){let v=a.render.frame;h.get(E)!==v&&(h.set(E,v),E.update())}function ee(E,v){let B=E.colorSpace,Z=E.format,J=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||B!==Mi&&B!==zn&&(Xt.getTransfer(B)===Jt?(Z!==on||J!==En)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",B)),v}function St(E){return typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement?(c.width=E.naturalWidth||E.width,c.height=E.naturalHeight||E.height):typeof VideoFrame<"u"&&E instanceof VideoFrame?(c.width=E.displayWidth,c.height=E.displayHeight):(c.width=E.width,c.height=E.height),c}this.allocateTextureUnit=C,this.resetTextureUnits=N,this.setTexture2D=G,this.setTexture2DArray=X,this.setTexture3D=Q,this.setTextureCube=q,this.rebindTextures=Bt,this.setupRenderTarget=ae,this.updateRenderTargetMipmap=Vt,this.updateMultisampleRenderTarget=Je,this.setupDepthRenderbuffer=Pt,this.setupFrameBufferTexture=_t,this.useMultisampledRTT=kt}function a0(i,t){function e(n,s=zn){let r,a=Xt.getTransfer(s);if(n===En)return i.UNSIGNED_BYTE;if(n===Ma)return i.UNSIGNED_SHORT_4_4_4_4;if(n===ba)return i.UNSIGNED_SHORT_5_5_5_1;if(n===al)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===sl)return i.BYTE;if(n===rl)return i.SHORT;if(n===as)return i.UNSIGNED_SHORT;if(n===Sa)return i.INT;if(n===li)return i.UNSIGNED_INT;if(n===wn)return i.FLOAT;if(n===os)return i.HALF_FLOAT;if(n===ol)return i.ALPHA;if(n===ll)return i.RGB;if(n===on)return i.RGBA;if(n===cl)return i.LUMINANCE;if(n===hl)return i.LUMINANCE_ALPHA;if(n===yi)return i.DEPTH_COMPONENT;if(n===Si)return i.DEPTH_STENCIL;if(n===ul)return i.RED;if(n===Ea)return i.RED_INTEGER;if(n===dl)return i.RG;if(n===wa)return i.RG_INTEGER;if(n===Ta)return i.RGBA_INTEGER;if(n===js||n===Qs||n===tr||n===er)if(a===Jt)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===js)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Qs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===tr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===er)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===js)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Qs)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===tr)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===er)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Aa||n===Ca||n===Ra||n===Pa)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Aa)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Ca)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Ra)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Pa)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Ia||n===La||n===Da)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Ia||n===La)return a===Jt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Da)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Ua||n===Na||n===Fa||n===Oa||n===Ba||n===za||n===ka||n===Ha||n===Va||n===Ga||n===Wa||n===Xa||n===qa||n===Ya)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Ua)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Na)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Fa)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Oa)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Ba)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===za)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===ka)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Ha)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Va)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Ga)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Wa)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Xa)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===qa)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Ya)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===nr||n===$a||n===Za)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===nr)return a===Jt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===$a)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Za)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===fl||n===Ka||n===Ja||n===ja)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===nr)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Ka)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Ja)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===ja)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Ti?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}var o0={type:"move"},sr=class{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new ze,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new ze,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new U,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new U),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new ze,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new U,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new U),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){let e=this._hand;if(e)for(let n of t.hand.values())this._getHandJoint(e,n)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,n){let s=null,r=null,a=null,o=this._targetRay,l=this._grip,c=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(c&&t.hand){a=!0;for(let x of t.hand.values()){let m=e.getJointPose(x,n),d=this._getHandJoint(c,x);m!==null&&(d.matrix.fromArray(m.transform.matrix),d.matrix.decompose(d.position,d.rotation,d.scale),d.matrixWorldNeedsUpdate=!0,d.jointRadius=m.radius),d.visible=m!==null}let h=c.joints["index-finger-tip"],u=c.joints["thumb-tip"],f=h.position.distanceTo(u.position),p=.02,_=.005;c.inputState.pinching&&f>p+_?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!c.inputState.pinching&&f<=p-_&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else l!==null&&t.gripSpace&&(r=e.getPose(t.gripSpace,n),r!==null&&(l.matrix.fromArray(r.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,r.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(r.linearVelocity)):l.hasLinearVelocity=!1,r.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(r.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(s=e.getPose(t.targetRaySpace,n),s===null&&r!==null&&(s=r),s!==null&&(o.matrix.fromArray(s.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,s.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(s.linearVelocity)):o.hasLinearVelocity=!1,s.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(s.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(o0)))}return o!==null&&(o.visible=s!==null),l!==null&&(l.visible=r!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){let n=new ze;n.matrixAutoUpdate=!1,n.visible=!1,t.joints[e.jointName]=n,t.add(n)}return t.joints[e.jointName]}},l0=`
void main() {
...
`)}function Du(i){let t=kn(),e=null,n=null,s=[],r="",a=0,o={search:document.getElementById("sportsSearch"),chips:document.getElementById("sportsChips"),seriesList:document.getElementById("sportsSeriesList"),detail:document.getElementById("sportsDetail"),detailTitle:document.getElementById("sportsDetailTitle"),detailDesc:document.getElementById("sportsDetailDesc"),eventsList:document.getElementById("sportsEventsList"),eventPanel:document.getElementById("sportsEventPanel"),eventTitle:document.getElementById("sportsEventTitle"),countdown:document.getElementById("sportsCountdown"),tuneIn:document.getElementById("sportsTuneIn"),schedule:document.getElementById("sportsSchedule"),clear:document.getElementById("btnClearSports"),toBridge:document.getElementById("btnSportsToBridge"),exportIcs:document.getElementById("btnSportsIcs"),upNext:document.getElementById("upNextRail"),browse:document.getElementById("sportsBrowse"),tabClocks:document.getElementById("tabClocks"),tabSports:document.getElementById("tabSports"),tabConvert:document.getElementById("tabConvert"),panelClocks:document.getElementById("panelClocks"),panelSports:document.getElementById("panelSports"),panelConvert:document.getElementById("panelConvert")};function l(y){return String(y).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function c(y){return y.tz.split("/").pop().replace(/_/g," ").toLowerCase()===y.city.toLowerCase()}function h(){return i.getFollowed?.()||[]}function u(){let y=h();return y.length?_n.filter(g=>y.includes(g.id)):_n}function f(y){let g=[["clocks",o.tabClocks,o.panelClocks],["sports",o.tabSports,o.panelSports],["convert",o.tabConvert,o.panelConvert]];for(let[T,N,C]of g)N?.classList.toggle("active",T===y),C&&(C.hidden=T!==y)}o.tabClocks?.addEventListener("click",()=>f("clocks")),o.tabSports?.addEventListener("click",()=>f("sports")),o.tabConvert?.addEventListener("click",()=>f("convert"));function p(){e=null,n=null,o.browse&&(o.browse.hidden=!1),o.detail&&(o.detail.hidden=!0),o.eventPanel&&(o.eventPanel.hidden=!0)}function _(){if(!o.chips)return;let y=[...new Set(_n.map(g=>g.category))];o.chips.innerHTML='<button type="button" class="chip-btn active" data-cat="">All</button>'+y.map(g=>`<button type="button" class="chip-btn" data-cat="${l(g)}">${l(g)}</button>`).join(""),o.chips.querySelectorAll(".chip-btn").forEach(g=>{g.addEventListener("click",()=>{o.chips.querySelectorAll(".chip-btn").forEach(T=>T.classList.remove("active")),g.classList.add("active"),x(o.search?.value||"",g.dataset.cat||"")})})}function x(y="",g=""){if(!o.seriesList)return;let T=y.trim()?Ql(y):_n.slice();g&&(T=T.filter(G=>G.category===g));let N=new Set(h()),C=y.trim()?Cu(y,5):[],H=C.length?`<div class="event-hits">
      ...
      `,s.querySelector(".clock-city").textContent=n.name,s.querySelector(".clock-region").textContent=n.region,s.addEventListener("click",r=>{r.target.closest("button")||hr(e)}),s.querySelector(".clock-remove").addEventListener("click",r=>{r.stopPropagation(),Bu(e)}),s.querySelector(".clock-focus").addEventListener("click",r=>{r.stopPropagation(),hr(e)}),V.clockList.appendChild(s)}for(let e of se){let n=V.clockList.querySelector(`.clock-card[data-id="${e}"]`);n&&V.clockList.appendChild(n)}}function yn(i){N0();let t=Zt?.getSunDir?.()||null;for(let e of se){let n=Se(e),s=V.clockList.querySelector(`.clock-card[data-id="${e}"]`);if(!n||!s)continue;let r=$l(n,i,An(),t),a=ci(i,n.tz,Xe);s.classList.toggle("day",r.isDay),s.classList.toggle("night",!r.isDay),s.classList.toggle("selected",Ne===e),s.querySelector(".clock-time").textContent=r.time,s.querySelector(".clock-dayoff").textContent=`${r.day} \xB7 ${r.offset}`,s.querySelector(".clock-delta").textContent=a.label+(a.dayNote?` \xB7 ${a.dayNote}`:"")}}function cc(i){Se(i)&&(se.includes(i)||(se=[i,...se],gs()),hr(i),yn(new Date))}function Bu(i){se=se.filter(t=>t!==i),gs(),yn(new Date),Ke()}function hr(i){Ne=i,Zt?.selectCity(i,!Gn),yn(new Date);let t=Se(i);t&&(dr(t),V.eventZone&&(V.eventZone.value=t.tz),Ke()),cr()}function cr(){if(V.btnPinSelected){if(!Ne){V.btnPinSelected.disabled=!0,V.btnPinSelected.textContent="Pin selected";return}V.btnPinSelected.disabled=!1,V.btnPinSelected.textContent=se.includes(Ne)?"Unpin selected":"Pin selected"}}V.btnPinSelected?.addEventListener("click",()=>{Ne&&(se.includes(Ne)?Bu(Ne):cc(Ne),cr())});V.btnResetPins?.addEventListener("click",()=>{confirm("Reset pinned clocks to defaults?")&&(se=[...Di],gs(),yn(new Date),Ke())});function ur(i){let t=i.trim();if(V.searchClear.hidden=!t,Vn=-1,!t){V.searchResults.hidden=!0,V.searchResults.innerHTML="";return}let e=xu(t);if(!e.length){V.searchResults.hidden=!1,V.searchResults.innerHTML='<div class="search-item"><span class="search-item-meta">No matches</span></div>';return}V.searchResults.hidden=!1,V.searchResults.innerHTML=e.map((n,s)=>`
      ...
      </button>`).join(""),V.searchResults.querySelectorAll(".search-item").forEach(n=>{n.addEventListener("click",()=>{hr(n.dataset.id),cc(n.dataset.id),V.searchInput.value="",ur("")})})}function Nu(i){let t=[...V.searchResults.querySelectorAll(".search-item[data-id]")];t.forEach((e,n)=>e.classList.toggle("active",n===i)),t[i]&&t[i].scrollIntoView({block:"nearest"})}V.searchInput?.addEventListener("input",()=>ur(V.searchInput.value));V.searchClear?.addEventListener("click",()=>{V.searchInput.value="",ur(""),V.searchInput.focus()});V.searchInput?.addEventListener("keydown",i=>{let t=[...V.searchResults.querySelectorAll(".search-item[data-id]")];if(i.key==="Escape"){V.searchInput.value="",ur(""),i.preventDefault();return}if(t.length){if(i.key==="ArrowDown")Vn=Math.min(t.length-1,Vn+1),Nu(Vn),i.preventDefault();else if(i.key==="ArrowUp")Vn=Math.max(0,Vn-1),Nu(Vn),i.preventDefault();else if(i.key==="Enter"){let e=Vn>=0?Vn:0,n=t[e]?.dataset.id;n&&(cc(n),V.searchInput.value="",ur("")),i.preventDefault()}}});function dr(i,t=new Date){if(!i||!V.hoverCard)return;let e=$l(i,t,An(),Zt?.getSunDir?.()),n=ci(t,i.tz,Xe);V.hoverCity.textContent=`${i.name}, ${i.region}`,V.hoverTime.textContent=e.time,V.hoverMeta.textContent=`${e.day} \xB7 ${e.offset} \xB7 ${n.label}${n.dayNote?" \xB7 "+n.dayNote:""}`,V.hoverCard.hidden=!1}function F0(i){if(rc)dr(rc,i);else if(Ne){let t=Se(Ne);t&&dr(t,i)}}function zu(i){if(V.localTime&&(V.localTime.textContent=Ae(i,Xe,{withSeconds:!0,hour12:An()})),V.localZone){let t=mt.homeCityId?Se(mt.homeCityId):null;V.localZone.textContent=t&&t.tz===Xe?`${t.name} \xB7 ${Xe.replace(/_/g," ")}`:Xe.replace(/_/g," ")}if(V.utcNow){let t=Ae(i,"UTC",{withSeconds:!0,hour12:An()});V.utcNow.textContent=`UTC ${t}`}}function O0(){if(!V.eventZone)return;let i=new Set,t=[];for(let e of ke)i.has(e.tz)||(i.add(e.tz),t.push({tz:e.tz,label:`${e.name} \u2014 ${e.tz}`}));t.sort((e,n)=>e.label.localeCompare(n.label)),V.eventZone.innerHTML=t.map(e=>`<option value="${e.tz}">${ce(e.label)}</option>`).join(""),V.eventZone.value="Europe/London"}function hc(){V.homeSelect&&(V.homeSelect.innerHTML=`<option value="">Auto (${ce(Xe)})</option>`+ke.map(i=>`<option value="${i.id}" ${mt.homeCityId===i.id?"selected":""}>${ce(i.name)} \xB7 ${ce(i.tz)}</option>`).join(""))}function Ke(){if(!V.eventDate||!V.eventTime||!V.eventZone)return;let i=V.eventDate.value,t=V.eventTime.value,e=V.eventZone.value,n=co(i,t,e,Xe);if(!n){V.bridgeValue&&(V.bridgeValue.textContent="\u2014"),V.bridgeDelta&&(V.bridgeDelta.textContent=""),V.bridgeTable&&(V.bridgeTable.innerHTML="");return}let s=Ae(n.instant,Xe,{withSeconds:!1,withDate:!0,hour12:An()});V.bridgeValue.textContent=`${s.time} \xB7 ${s.day}`;let r=ke.find(h=>h.tz===e),a=r?r.name:e,o=Ae(n.instant,e,{withSeconds:!1,withDate:!0,hour12:An()});V.bridgeDelta.textContent=`when it is ${o.time} in ${a}`;let l=se.map(h=>Se(h)).filter(Boolean).map(h=>({id:h.id,name:h.name,tz:h.tz})),c=ho(i,t,e,l,Xe,An());c&&V.bridgeTable&&(V.bridgeTable.innerHTML=`
      ...
      </table>`,V.bridgeTable.querySelectorAll("tr[data-id]").forEach(h=>{h.addEventListener("click",()=>hr(h.dataset.id))}))}function B0(){if(!V.bridgeChips)return;let i=Wl(new Date,Xe);V.bridgeChips.innerHTML=i.map(t=>`<button type="button" class="chip-btn" data-chip="${t.id}">${ce(t.label)}</button>`).join(""),V.bridgeChips.querySelectorAll(".chip-btn").forEach(t=>{t.addEventListener("click",()=>{let e=i.find(n=>n.id===t.dataset.chip);e&&(V.eventDate.value=e.dateStr,V.eventTime.value=e.timeStr,e.fromTz&&(V.eventZone.value=e.fromTz),Ke())})})}V.eventTime?.addEventListener("input",Ke);V.eventDate?.addEventListener("input",Ke);V.eventZone?.addEventListener("change",Ke);V.btnCopyBridge?.addEventListener("click",async()=>{let i=V.eventDate.value,t=V.eventTime.value,e=V.eventZone.value,n=se.map(o=>Se(o)).filter(Boolean).map(o=>({id:o.id,name:o.name,tz:o.tz})),s=ho(i,t,e,n,Xe,An());if(!s)return;let r=ke.find(o=>o.tz===e),a=Gl(`Event ${t} ${i}`,r?`${r.name} (${e})`:e,s.rows,{time:s.local.time,day:s.local.day});try{await navigator.clipboard.writeText(a),V.btnCopyBridge.textContent="Copied!",setTimeout(()=>{V.btnCopyBridge.textContent="Copy conversion"},1500)}catch{V.btnCopyBridge.textContent="Copy failed"}});function uc(){if(!V.groupsBar)return;let i=mt.favoriteGroups||{},t=Object.keys(i);V.groupsBar.innerHTML=`<button type="button" class="chip-btn ${mt.activeGroup?"":"active"}" data-group="">All pins</button>`+t.map(e=>`<button type="button" class="chip-btn ${mt.activeGroup===e?"active":""}" data-group="${ce(e)}">${ce(e)}</button>`).join("")+'<button type="button" class="chip-btn" data-group="__apply">Apply group</button>',V.groupsBar.querySelectorAll(".chip-btn").forEach(e=>{e.addEventListener("click",()=>{let n=e.dataset.group;if(n==="__apply"){mt.activeGroup&&i[mt.activeGroup]&&(se=i[mt.activeGroup].filter(s=>Se(s)),gs(),yn(new Date),Ke());return}mt=Ue({activeGroup:n||null}),uc(),n&&i[n]})})}function z0(){document.getElementById("btnExportPins")?.addEventListener("click",()=>{let i=Eu({...mt,pinnedIds:se}),t=new Blob([JSON.stringify(i,null,2)],{type:"application/json"}),e=document.createElement("a");e.href=URL.createObjectURL(t),e.download="apextimezones-pins.json",e.click(),URL.revokeObjectURL(e.href)}),document.getElementById("btnImportPins")?.addEventListener("click",()=>{document.getElementById("importFile")?.click()}),document.getElementById("importFile")?.addEventListener("change",async i=>{let t=i.target.files?.[0];if(t){try{let e=await t.text(),n=wu(e,{...mt,pinnedIds:se});mt=Kl(n),se=Yl(mt.pinnedIds),gs(),yn(new Date),hc(),uc(),alert("Import successful")}catch(e){alert("Import failed: "+e.message)}i.target.value=""}})}function dc(){let i=(mt.reminders||[]).map(t=>{if(t.fireAt)return t;try{let[e,n,s]=t.dateStr.split("-").map(Number),[r,a]=t.timeStr.split(":").map(Number),o=fs(e,n,s,r,a,t.tz||Xe);if(!o)return t;let l=Number(t.notifyMinutes||15),c=o.getTime()-l*6e4;return{...t,fireAt:c,body:`${t.title} in ~${l} min`}}catch{return t}});mt=Ue({reminders:i}),de?.setMainSettings?.({reminders:i}),k0()}function k0(){if(!V.reminderList)return;let i=mt.reminders||[];V.reminderList.innerHTML=i.map(t=>`<div class="reminder-row">
          <span>${ce(t.title)} \xB7 ${ce(t.dateStr)} ${ce(t.timeStr)} (${ce(t.tz||"")})</span>
          <button type="button" data-del="${t.id}" class="ghost-btn">\u2715</button>
        </div>`).join("")||'<div class="muted">No saved events</div>',V.reminderList.querySelectorAll("[data-del]").forEach(t=>{t.addEventListener("click",()=>{let e=(mt.reminders||[]).filter(n=>n.id!==t.dataset.del);mt=Ue({reminders:e}),dc()})})}function ku({title:i,dateStr:t,timeStr:e,tz:n,notifyMinutes:s=15}){if(!t||!e)return;let r="r_"+Date.now()+"_"+Math.random().toString(36).slice(2,6),a=[...mt.reminders||[],{id:r,title:i||"Event",dateStr:t,timeStr:e,tz:n,notifyMinutes:s,fired:!1}];mt=Ue({reminders:a}),dc()}V.btnSaveReminder?.addEventListener("click",()=>{ku({title:V.reminderTitle?.value?.trim()||"Event",dateStr:V.eventDate.value,timeStr:V.eventTime.value,tz:V.eventZone.value,notifyMinutes:Number(V.reminderNotify?.value||15)}),V.reminderTitle&&(V.reminderTitle.value="")});function H0(){let i=document.getElementById("updateBanner"),t=document.getElementById("updateTitle"),e=document.getElementById("updateNotes"),n=document.getElementById("updateProgressWrap"),s=document.getElementById("updateProgressBar"),r=document.getElementById("updateProgressLabel"),a=document.getElementById("btnUpdateNow"),o=document.getElementById("btnUpdateLater"),l=c=>{i&&(t&&(t.textContent=`Update available \xB7 v${c.latestVersion||""}`),e&&(e.textContent=c.releaseNotes||`You have v${c.currentVersion}. A newer build is ready to install.`),i.hidden=!1)};de?.onUpdateAvailable?.(c=>l(c)),de?.onUpdateNotAvailable?.(c=>{i&&(i.hidden=!0),alert(`You're up to date (v${c?.currentVersion||""}).`)}),de?.onUpdateProgress?.(c=>{n&&(n.hidden=!1),s&&(s.style.width=`${c.percent||0}%`),r&&(r.textContent=`${c.percent||0}% \xB7 ${c.status||""}`),a&&(a.disabled=!0,a.textContent=c.status==="installing"?"Restarting\u2026":"Downloading\u2026")}),de?.onUpdateError?.(c=>{a&&(a.disabled=!1,a.textContent="Update now"),alert("Update failed: "+(c?.message||"unknown error"))}),o?.addEventListener("click",()=>{i&&(i.hidden=!0)}),a?.addEventListener("click",async()=>{a&&(a.disabled=!0,a.textContent="Downloading\u2026"),n&&(n.hidden=!1);try{await de?.downloadUpdate?.()}catch(c){alert("Update failed: "+(c?.message||c)),a&&(a.disabled=!1,a.textContent="Update now")}}),document.getElementById("btnCheckUpdates")?.addEventListener("click",async()=>{try{let c=await de?.checkForUpdates?.();c?.available?l(c):c?.ok?alert(`You're up to date (v${c.currentVersion}).`):alert("Could not check for updates"+(c?.reason?`: ${c.reason}`:"."))}catch(c){alert("Update check failed: "+(c?.message||c))}})}function V0(){document.getElementById("btnHelp")?.addEventListener("click",()=>Hu())}function G0(){let i=()=>{de?.openApexForge?de.openApexForge():de?.openExternal?.("https://ame-apexforge.org/")};document.getElementById("btnApexForge")?.addEventListener("click",i),document.getElementById("btnApexForgeSettings")?.addEventListener("click",i)}function W0(){let i=V.settingsPanel;if(!i)return;document.getElementById("btnSettings")?.addEventListener("click",()=>{i.hidden=!i.hidden,i.hidden||X0()}),document.getElementById("btnCloseSettings")?.addEventListener("click",()=>{i.hidden=!0});let t=(n,s,r)=>{let a=document.getElementById(n);a&&(a.checked=!!mt[s],a.addEventListener("change",()=>{mt=Ue({[s]:a.checked}),r?.(a.checked)}))};t("setHour12","hour12",()=>{oc(new Date),Ke()}),t("setAlwaysOnTop","alwaysOnTop",n=>de?.setAlwaysOnTop?.(n)),t("setAutoRotate","autoRotate",n=>Zt?.setAutoRotate(n)),t("setReducedMotion","reducedMotion",n=>{document.body.classList.toggle("reduced-motion",n),n&&Zt?.setAutoRotate(!1)}),t("setShowGrid","showGrid",n=>Zt?.setShowGrid(n)),t("setShowBands","showTzBands",n=>Zt?.setShowBands(n)),t("setStartWindows","startWithWindows",n=>de?.setStartWithWindows?.(n));let e=document.getElementById("setQuality");e&&(e.value=mt.quality||"high",e.addEventListener("change",()=>{mt=Ue({quality:e.value}),Zt?.setQuality(e.value)})),document.getElementById("btnToggleWidget")?.addEventListener("click",()=>{ac(!Gn)}),V.homeSelect?.addEventListener("change",()=>{let n=V.homeSelect.value||null;mt=Ue({homeCityId:n}),Zt?.setHomeCity(n),zu(new Date)}),q0(),document.getElementById("traySelect")?.addEventListener("change",n=>{let s=[...n.target.selectedOptions].map(r=>r.value).slice(0,5);mt=Ue({trayCityIds:s}),de?.setMainSettings?.({trayCityIds:s}),fc()})}function X0(){let i=document.getElementById("traySelect");if(!i)return;let t=new Set(mt.trayCityIds||[]),e=[...new Set([...mt.trayCityIds||[],...se])];i.innerHTML=e.map(n=>Se(n)).filter(Boolean).map(n=>`<option value="${n.id}" ${t.has(n.id)?"selected":""}>${ce(n.name)} \xB7 ${ce(n.tz)}</option>`).join("")}function q0(){let i=document.getElementById("hotkeyInput");if(!i)return;i.value=mt.hotkey||"CommandOrControl+Alt+T";let t=async e=>{try{let n=await de?.setHotkey?.(e);n?.ok?(mt=Ue({hotkey:n.hotkey}),i.value=n.hotkey):(i.value=(mt.hotkey||"")+"  (in use \u2014 try another)",setTimeout(()=>{i.value=mt.hotkey||""},1600))}catch{i.value=mt.hotkey||""}};i.addEventListener("focus",()=>{i.value="Press keys\u2026"}),i.addEventListener("blur",()=>{i.value=mt.hotkey||""}),i.addEventListener("keydown",e=>{e.preventDefault();let n=e.key;if(["Control","Alt","Shift","Meta"].includes(n))return;let s=[];if((e.ctrlKey||e.metaKey)&&s.push("CommandOrControl"),e.altKey&&s.push("Alt"),e.shiftKey&&s.push("Shift"),!s.length)return;let r=n.length===1?n.toUpperCase():n;r===" "&&(r="Space"),t([...s,r].join("+")),i.blur()}),document.getElementById("btnResetHotkey")?.addEventListener("click",()=>{t("CommandOrControl+Alt+T")})}function ac(i){Gn=!!i,mt=Ue({widgetMode:Gn}),document.body.classList.toggle("widget-mode",Gn),V.app?.classList.toggle("widget-mode",Gn),requestAnimationFrame(()=>{if(Zt?.resize(),!i&&Ne){let t=Se(Ne);t&&Zt?.flyTo(t.lat,t.lng,.8)}})}function Hu(){if(!V.onboarding)return;let i=!mt.onboardingDone,t=[...V.onboarding.querySelectorAll(".tour-step")],e=document.getElementById("tourDots"),n=document.getElementById("onboardNext"),s=document.getElementById("onboardBack"),r=document.getElementById("onboardSkip"),a=document.getElementById("onboardHome"),o=0;a&&!a.dataset.filled&&(a.innerHTML=ke.map(h=>`<option value="${h.id}">${ce(h.name)} (${ce(h.region)})</option>`).join(""),a.dataset.filled="1"),a&&mt.homeCityId&&(a.value=mt.homeCityId);let l=()=>{t.forEach((h,u)=>h.hidden=u!==o),e&&(e.innerHTML=t.map((h,u)=>`<span class="dot ${u===o?"active":""}"></span>`).join("")),s&&(s.hidden=o===0),n&&(n.textContent=o===t.length-1?"Let's go":"Next")},c=h=>{if(h&&i){let u=a?.value||null,f=[...document.querySelectorAll("#onboardPins input:checked")].map(p=>p.value);u&&(mt=Ue({homeCityId:u})),f.length&&(se=f.filter(p=>Se(p)),gs()),Zt?.setHomeCity(mt.homeCityId),hc(),yn(new Date)}mt=Ue({onboardingDone:!0}),V.onboarding.hidden=!0};n&&(n.onclick=()=>o<t.length-1?(o++,l()):c(!0)),s&&(s.onclick=()=>(o=Math.max(0,o-1),l())),r&&(r.onclick=()=>c(!1)),V.onboarding.hidden=!1,l()}function Y0(){if(mt.onboardingDone||Ou){V.onboarding&&(V.onboarding.hidden=!0);return}Hu()}function fc(){let i=new Date,e=(mt.trayCityIds&&mt.trayCityIds.length?mt.trayCityIds:se).slice(0,5).map(s=>Se(s)).filter(Boolean).map(s=>({id:s.id,name:s.name,time:Ae(i,s.tz,{withSeconds:!1,hour12:An()})})),n=lc?.nextFollowed?.();if(n?.session?.instant){let s=n.session.instant.getTime()-i.getTime(),r=n.session.isWindow&&s<0?"window open":ps(s);e.unshift({id:"next-event",name:`\u25B8 ${n.event.name}`,time:r})}de?.setTrayTimes?.(e)}function Fu(i){V.btnMax&&(V.btnMax.textContent=i?"\u2750":"\u25A1")}function oc(){let i=new Date;zu(i),yn(i),F0(i),Zt?.updateClocks(i),lc?.tick?.(),fc()}async function $0(){document.body.classList.toggle("reduced-motion",!!mt.reducedMotion),Gn&&ac(!0),V.eventDate&&(V.eventDate.value=ql(Xe)),O0(),hc(),B0(),uc(),z0(),W0(),H0(),G0(),V0(),lc=Du({hour12:An,getGlobe:()=>Zt,setBridge:({dateStr:i,timeStr:t,fromTz:e})=>{V.eventDate&&i&&(V.eventDate.value=i),V.eventTime&&t&&(V.eventTime.value=t),V.eventZone&&e&&(V.eventZone.value=e),Ke()},registerGlobeHandlers:i=>{Uu=i},getFollowed:()=>mt.followedSeriesIds||[],toggleFollowed:i=>{let t=new Set(mt.followedSeriesIds||[]);return t.has(i)?t.delete(i):t.add(i),mt=Ue({followedSeriesIds:[...t]}),[...t]},addReminder:ku});try{let i=await de?.getSportsCatalog?.();i&&jl(i,"feed-cache")}catch{}de?.onSportsCatalog?.(i=>jl(i,"feed")),Y0(),dc(),yn(new Date),Ke(),cr();try{let i=await de?.getMainSettings?.();if(i){if(typeof i.alwaysOnTop=="boolean"){mt=Ue({alwaysOnTop:i.alwaysOnTop});let t=document.getElementById("setAlwaysOnTop");t&&(t.checked=i.alwaysOnTop)}if(typeof i.startWithWindows=="boolean"){let t=document.getElementById("setStartWindows");t&&(t.checked=i.startWithWindows)}}}catch{}if(de?.onWindowState?.(i=>{i&&typeof i.maximized=="boolean"&&Fu(i.maximized)}),de?.isMaximized?.().then(i=>Fu(!!i)),de?.onVisibility?.(i=>{Zt?.setPaused(!i)}),de?.onToggleWidget?.(()=>ac(!Gn)),document.addEventListener("visibilitychange",()=>{Zt?.setPaused(document.hidden)}),Gn)V.loadingOverlay&&(V.loadingOverlay.style.display="none");else if(Zt=new uo(V.canvas,{onReady:()=>{V.loadingOverlay?.classList.add("fade-out"),setTimeout(()=>{V.loadingOverlay&&(V.loadingOverlay.style.display="none")},500),Zt.setAutoRotate(mt.autoRotate&&!mt.reducedMotion),Zt.setShowGrid(mt.showGrid!==!1),Zt.setShowBands(!!mt.showTzBands),Zt.setQuality(mt.quality||"high"),Zt.setHomeCity(mt.homeCityId)},onHover:i=>{rc=i,i?dr(i):Ne?dr(Se(Ne)):V.hoverCard&&(V.hoverCard.hidden=!0)},onPinClick:i=>{Ne=i.id,yn(new Date),cr(),V.eventZone&&(V.eventZone.value=i.tz),Ke()},onSelect:i=>{Ne=i,yn(new Date),cr()},onEventClick:i=>Uu?.onEventClick?.(i),onEventHover:i=>{!i||!V.hoverCard||(V.hoverCity.textContent=i.name,V.hoverTime.textContent="Sports event",V.hoverMeta.textContent=`${i.city||""} \xB7 click for schedule`,V.hoverCard.hidden=!1)}}),Zt.setPinned(se),await Zt.init(),Zt.resize(),mt.homeCityId){let i=Se(mt.homeCityId);i&&Zt.flyTo(i.lat,i.lng,1.4)}else if(Zt.localCityId){let i=Se(Zt.localCityId);i&&Zt.flyTo(i.lat,i.lng,1.4)}oc(),setInterval(oc,1e3),setInterval(Ke,3e4)}function ce(i){return String(i).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}$0().catch(i=>{console.error(i),U0("Couldn't load the globe \u2014 "+(i?.message||"see logs"))});})();
